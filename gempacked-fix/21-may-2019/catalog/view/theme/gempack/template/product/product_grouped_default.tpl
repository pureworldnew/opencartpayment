...
<?php } ?>
                        ...
                        <div class="hidden-lg hidden-md hidden-sm mobile-product-images">
                            <div id="mobile-images" class="owl-carousel">
                                <div class="item"><img src="<?php echo $popup; ?>" alt="<?php echo $heading_title; ?>" class="img-responsive" /></div>
<?php if ($images) { ?>
<?php foreach ($images as $image) { ?>
    ...
    <div id="wwell_prods_load" class="owl-carousel product-carousel">
                ...
                <?php $seeall = "index.php?route=product/search&getAllRelated&product_id=" . $product_id; ?>
                    <div class="item text-center">
                        <div class="product-item">
                        <div class="name">
                            <a href="" title="See All">See All</a></div>
...
<?php if ($discounts) { ?>
    ...
    <!--<script src="catalog/view/javascript/group.product.page.v2.js" type="text/javascript"></script>--> 
<?php if ($logged) { ?>
	<script>
