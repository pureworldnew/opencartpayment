...
<div class="row">
	...
	<div class="image"><a href="<?php echo $zoom_image; ?>" title="<?php echo $custom_imgtitle; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" id="image"  class="cloudzoom" data-cloudzoom = "zoomSizeMode: 'image',startMagnification:1.9,tintColor:'#000',tintOpacity:0.25,captionPosition:'bottom',maxMagnification:4,autoInside:750"/></a></div>   
 ...
 <!--New product count-->
               ...
               if($product['stockquantity']==0) { ?>
                    ...
                    <!--custom product-->
						<?php } else { ?>
                            <li><a class="thumbnail" href="<?php echo HTTP_SERVER; ?>catalog/view/theme/default/image/no_product.jpg" title="<?php echo $custom_imgtitle; ?>"><img src="<?php echo HTTP_SERVER; ?>catalog/view/theme/default/image/no_product.jpg" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" id="image" /></a></li>
 <!--New product count-->
                    <?php foreach($images as $product) {  } ?>
                    <?php $datetime1 = new DateTime($product['date']);
                    $datetime2 = new DateTime();
							...
							<?php if (count($images) + count($videos) >= 2) { ?>
								<?php if ($images) { ?>
									<?php foreach($images as $image) { ?>
										<li class="media_additional" style="display: inline-block"><a id="image" class="media_thumbnail" href="<?php echo $image['popup']; ?>" title="<?php echo $custom_imgtitle; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" /></a></li>
									<?php } ?>
								<?php } ?>
							<?php } else { ?>
								<?php if ($images) { ?>
		...
		<a href="<?php echo $zoom_image; ?>" title="<?php echo $custom_imgtitle; ?>" class="cloudzoom-gallery" data-cloudzoom="useZoom: '.cloudzoom', image: '<?php echo $thumb; ?>', zoomImage:'<?php echo $zoom_image; ?>' "><img src="<?php echo $popup; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" id="image" class="img-responsive" /></a>
		...
		<a href="<?php echo $image['zoom_image']; ?>" title="<?php echo $custom_imgtitle; ?>" class="cloudzoom-gallery" data-cloudzoom="useZoom: '.cloudzoom', image: '<?php echo $image['thumbimage']; ?>', zoomImage:'<?php echo $image['zoom_image']; ?>' "><img src="<?php echo $image['thumbimage']; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" /></a>	
					...
					<?php if (count($images) + count($videos) >= 2) { ?>
						<?php if ($videos) { $i = 0;?>
							<div class="video_player thumbnail" style="display: block;">
								<?php foreach ($videos as $video) { ?>
									<?php if ($video['file_type'] == 'youtube'){ ?>
										<li class="media_additional" style="display: inline-block;width: 49%;padding: 3px;"><iframe class="media_thumbnail" src="<?php echo $video['video']; ?>"></iframe></li>
									<?php } else {?>
										<?php if ($poster) { ?>
											<li class="media_additional" style="display: inline-block;width: 49%;padding: 3px;"><a class="media_thumbnail" href="<?php echo $video['video'];?>" id="video"><video class="media_thumbnail" controls preload="none" poster = '<?php echo $poster;?>' style="width: 100%;"><source src="<?php echo $video['video'];?>" type="<?php echo $video['video_type']; ?>">Your browser does not support the video tag.</video></a></li>
										<?php }else{ ?>
											<li class="media_additional" style="display: inline-block;width: 49%;padding: 3px;"><a class="media_thumbnail" href="<?php echo $video['video'];?>" id="video"><video class="media_thumbnail" style="width: 100%;"><source src="<?php echo $video['video'];?>" type="<?php echo $video['video_type']; ?>">Your browser does not support the video tag.</video></a></li>
										<?php } ?>
									<?php } ?>
								<?php $i++;} ?>
							</div>	
					...
					<?php } else { ?>
						...
						<?php if (!empty($videos)){
							...
							<?php if ($video['file_type'] == 'youtube') { ?>
								<?php if (!empty($video)) : ?>
									<div class="video_player"><iframe width="100%" height="400px" src="<?php echo $video; ?>"></iframe></div>
								<?php endif; ?>
							<?php } else { ?>
								<?php if ($video['video']) : ?>
									<div class="video_player thumbnail" style="display: block;">
										<?php if ($poster) { ?>
											<video controls preload="none" poster = '<?php echo $poster;?>' style="width: 100%;" id="videoPlayer"><source src="<?php echo $video['video'];?>" type="<?php echo $video['video_type']; ?>">Your browser does not support the video tag.</video>
										<?php }else{ ?>
											<video controls preload="metadata" style="width: 100%;" id="videoPlayer"><source src="<?php echo $video['video'];?>#t=1" type="<?php echo $video['video_type']; ?>">Your browser does not support the video tag.</video>
										<?php } ?>
									</div>
								<?php endif; ?>
							<?php } ?> 
				...
				<div class="hidden-lg hidden-md hidden-sm mobile-product-images">
                    <div id="mobile-images" class="owl-carousel">
                        <!--<div class="item"><img src="<?php echo $popup; ?>" alt="<?php echo $custom_alt; ?>" class="img-responsive" id="image_mob"/></div>-->
                        <?php if ($images) { ?>
		...
		<a href="<?php echo $image['zoom_image']; ?>" title="<?php echo $custom_imgtitle; ?>" class="cloudzoom-gallery" data-cloudzoom="useZoom: '.cloudzoom', image: '<?php echo $image['thumbimage']; ?>', zoomImage:'<?php echo $image['zoom_image']; ?>' "><img src="<?php echo $image['thumbimage']; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" /></a>	
				...
				<div class="col-sm-8">
					<div class="row">
						<div class="col-xs-8"><h3 class="hidden-xs"><?php echo $heading_title; ?></h3></div>
						<div class="col-xs-4">
					...
					<div class="row">
								...
								<div class="rating">
									<p>
										<?php for ($i = 1; $i <= 5; $i++) { ?>
											...
											<?php } ?>
										<?php } ?>
										(<a href="#" id="goto-reviews"><?php echo $reviews; ?></a>)
									</p>
								</div>
							<?php } ?>
							<?php if ($options) { ?>
						...
						<div class="col-md-6">
							<ul class="list-unstyled">
								<li>Item Numbers: <?php echo $sku; ?></li>
							...
							<ul class="list-unstyled price">
								<?php if (!$special) { ?>
									...
									<!-- <li>Price: <strong><?php echo $price; ?><span class="unit"> /  <?php echo $unit_singular; ?></span></strong></li> -->
								<?php } else { ?>
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab-description">
					...
					<?php } ?>
                            ...
                            <div id="embed-tab-article" class="tab_product_articles">
                            <?php if($embeded_product_article){ ?>
                            <?php foreach($embeded_product_article as $article){ ?>
                                <table class="table table-bordered articles">
                                    <thead>
                                            <tr>
                                                <td class="background_td"><strong><?php echo  $article['title']; ?></strong></td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                <tr>
                            ...
                            <div id="tab-articles" class="tab_product_articles">
                               <?php if ($product_articles) { ?>
                                <table class="table table-bordered articles">
                                <thead>
                                            <tr>
                                                <td class="background_td"><strong>More Helpful Links</strong></td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                    <?php foreach ($product_articles as $article) { ?>
                                                <tr>
                                                    <td><a href="<?php echo $article['name']; ?>" rel="nofollow" target="_blank"><?php echo $article['display_text']; ?></a></td>
                                               </tr>
                                    <?php } ?>
                                        </tbody>
                                </table>
			...
			<?php if(true) : ?>
				<div class="box" id="wwell_wrapper" style="display:<?php echo ($wproducts)?'block':'none' ?>">
					...
					<div class="box-content">
						<div id="wwell_prods" class="owl-carousel product-carousel">
							<?php 
							...
							<?php foreach ( $wproducts as $rproduct ) : ?>
								...
								<div class="item text-center">
									<div class="product-item">
										...
										<?php } else { ?>
											<div class="image"><img src="<?php echo HTTP_SERVER; ?>catalog/view/theme/default/image/no_product.jpg" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $rproduct['name']; ?>" /></div>
										<?php } ?>
										<div class="price">
			...
			<?php if(true) : ?>
				<div class="box" id="related_wrapper" style="display:<?php echo ($products)?'block':'none' ?>">
					...
					<div class="box-content">
						<div id="related_prods" class="owl-carousel product-carousel">
							<?php 
							...
							<?php foreach($products as $rproduct) : ?>
								...
								<div class="item text-center">
									<div class="product-item">
										<div class="name"><a href="<?php echo $rproduct['href']; ?>" title="<?php echo $rproduct['description']; ?>"><?php echo $rproduct['name']?></a></div>
										<?php if ($rproduct['thumb']) { ?>
											<div class="image"><a href="<?php echo $rproduct['href'] ?>"><img src="<?php echo $rproduct['thumb'] ?>" title="<?php echo $rproduct['name']; ?>" alt="<?php echo $rproduct['name']; ?>"></a></div>
										<?php } else { ?>
											<div class="image"><img src="<?php echo HTTP_SERVER; ?>catalog/view/theme/default/image/no_product.jpg" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $rproduct['name']; ?>" /></div>
						...
						<div class="modal-body">
							...
							<div class="tab-content">
										...
										<div class="col-sm-8">
											...
											<?php if (!empty($videos)){?>
												<?php if (isset($videos[0])) { $video = $videos[0]; ?>
													...
													<?php } else {?>
														<?php if ($video['video']) : ?>
															<div class="" id="mainVideo">
																<?php if ($poster) { ?>
																	<video controls preload="none" poster = '<?php echo $poster;?>' style="width: 100%;" id="bigVideoPlayer"><source src="<?php echo $video['video'];?>" type="<?php echo $video['video_type']; ?>">Your browser does not support the video tag.</video>
																<?php }else{ ?>
																	<video controls preload="metadata" style="width: 100%;" id="bigVideoPlayer"><source src="<?php echo $video['video'];?>#t=0.1" type="<?php echo $video['video_type']; ?>">Your browser does not support the video tag.</video>
																<?php } ?>
															</div>
														<?php endif; ?>
													<?php } ?> 
											...
											<?php if ($videos) { ?>
												<div class="thumbnails">
													<?php foreach($videos as $video ) { ?>
														...
														<?php }else{ ?>
															<?php if ($poster) { ?>
																<a class="media_thumbnail" href="<?php echo $video['video'];?>"><video preload="none" poster = '<?php echo $poster;?>' style="width: 48%; padding: 3px;"><source src="<?php echo $video['video'];?>" type="<?php echo $video['video_type']; ?>">Your browser does not support the video.</video></a>
															<?php }else{ ?>
																<a class="media_thumbnail" href="<?php echo $video['video'];?>"><video preload="metadata" style="width: 48%;  padding: 3px;" ><source src="<?php echo $video['video'];?>#t=1" type="<?php echo $video['video_type']; ?>"></video></a>
															<?php } ?>
														<?php } ?>
													<?php } ?>
												</div>
								...
								<div id="cimages" class="tab-pane fade in active">
									<div class="row">
										<div class="col-sm-8"> 
											<a href="<?php echo $zoom_image; ?>" title="<?php echo $custom_imgtitle; ?>" id="bigImagePlayer"><img id="popupImage" src="<?php echo $popup; ?>" class="cloudzoom_popup" data-cloudzoom = "zoomSizeMode: 'image',startMagnification:1.9,tintColor:'#000',tintOpacity:0.25,captionPosition:'bottom',maxMagnification:4,autoInside: true,zoomPosition:'inside'"/></a>
										</div>
										<div class="col-sm-4">
											...
											<?php if ($images) { ?>
												<div class="thumbnails hidden-xs">
													<?php foreach($images as $image ) { ?>
														<a href="<?php echo $image['zoom_image']; ?>" title="<?php echo $custom_imgtitle; ?>" class="cloudzoom-gallery" data-cloudzoom="useZoom: '.cloudzoom_popup', image: '<?php echo $image['popup']; ?>', zoomImage:'<?php echo $image['zoom_image']; ?>' "><img src="<?php echo $image['thumb']; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" /></a>
													<?php } ?>
												</div>
											<?php } ?>
										</div>
			...
			<script>
				$('#wwell_prods').owlCarousel({
					items: 4,
					navigation: true,
					navigationText: ['<i class="fa fa-chevron-left fa-5x"></i>', '<i class="fa fa-chevron-right fa-5x"></i>'],
					pagination: false
				});
				$('#related_prods').owlCarousel({
					items: 4,
					navigation: true,
					navigationText: ['<i class="fa fa-chevron-left fa-5x"></i>', '<i class="fa fa-chevron-right fa-5x"></i>'],
					pagination: false
