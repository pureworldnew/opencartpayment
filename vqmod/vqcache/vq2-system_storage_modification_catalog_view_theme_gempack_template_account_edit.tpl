                ...
                <div class="content">
                    <table class="form">
                        ...
                        <tr>
                          	...
                          	<td><input type="text" class="form-control" name="resale_number" value="<?php echo $resale_number; ?>" />
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="company_id" value="<?php echo $company_id; ?>" /></td>
                        </tr>
