...
class Cart {
	...
	public function __construct($registry) {
		...
		$registry->set('abandonedcart', new Abandonedcart($registry));
		
		$this->abandonedcart = $registry->get('abandonedcart');
		...
		if ($this->customer->getId()) {
			...
			// Abandoned Cart xml starts
				$this->db->query("DELETE FROM " . DB_PREFIX . "abandonedcart WHERE cart_id = '" . (int)$cart['cart_id'] . "'");
				// Abandoned Cart xml ends
...
public function add_pos_products($order_products) {
