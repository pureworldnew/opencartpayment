...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
			...
			$sql = "SELECT o.customer_id, o.order_id, CONCAT(o.invoice_prefix, o.invoice_no) AS invoice, o.invoice_prefix AS invoice_prefix, o.invoice_no AS invoice_number,CONCAT(o.firstname, ' ', o.lastname) AS customer, o.order_status_id, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status, o.shipping_code, o.total, o.store_id AS store_id, o.store_name AS store_name, o.currency_code, o.currency_value, o.date_added, o.date_modified, o.* FROM `" . DB_PREFIX . "order` o"; 
