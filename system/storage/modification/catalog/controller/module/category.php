...
if($this->model_catalog_product->virtualStatus() && $category['category_id'] == $this->model_catalog_product->virtualId()) {
			...
			'name'        => $category['name'] . ($this->config->get('config_product_count') ? ' ('.$productlimit['limit'].')' : ''),
