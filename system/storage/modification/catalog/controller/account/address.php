...
class ControllerAccountAddress extends Controller {
	...
	public function setdefault() {
		...
		if (isset($this->request->get['address_id']) && $this->validateDelete()) {
			$this->model_account_address->setdefaultAddress($this->request->get['address_id']);
			...
			$this->model_account_activity->addActivity('address_updated', $activity_data);
	...
	protected function getList() {
		...
		$data['btn_main_address'] = $this->language->get('btn_main_address');
		$data['btn_set_as_default'] = $this->language->get('btn_set_as_default');
		...
		foreach ($results as $result) {
			...
			$data['addresses'][] = array(
				...
				'setdefault'     => $this->url->link('account/address/setdefault', 'address_id=' . $result['address_id'], 'SSL')
