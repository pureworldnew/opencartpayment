...
class ModelAccountCustomer extends Model {
	...
	public function editCustomer($data) { 
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', comments = '" . $this->db->escape($data['comment']) . "', resale_number = '" . $this->db->escape($data['resale_number']) . "', company_id = '" . $this->db->escape($data['company_id']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? json_encode($data['custom_field']) : '') . "' WHERE customer_id = '" . (int)$customer_id . "'");
