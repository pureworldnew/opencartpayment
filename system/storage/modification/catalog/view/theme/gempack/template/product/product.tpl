...
<div class="row">
 ...
 <!--New product count-->
               ...
               if($product['stockquantity']==0) { ?>
                    ...
                    <!--custom product-->
						<?php } else { ?>
                            <li><a class="thumbnail" href="<?php echo HTTP_SERVER; ?>catalog/view/theme/default/image/no_product.jpg" title="<?php echo $heading_title; ?>"><img src="<?php echo HTTP_SERVER; ?>catalog/view/theme/default/image/no_product.jpg" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></li>
 <!--New product count-->
                    <?php foreach($images as $product) {  } ?>
                    <?php $datetime1 = new DateTime($product['date']);
                    $datetime2 = new DateTime();
               ...
               if($product['stockquantity']==0) { ?>
							...
							<?php if (count($images) + count($videos) >= 2) { ?>
								<?php if ($images) { ?>
									<?php foreach($images as $image) { ?>
										<li class="media_additional" style="display: inline-block"><a id="image" class="media_thumbnail" href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
									<?php } ?>
								<?php } ?>
							<?php } else { ?>
								<?php if ($images) { ?>
				...
				<div class="hidden-lg hidden-md hidden-sm mobile-product-images">
                    <div id="mobile-images" class="owl-carousel">
                        ...
                        <?php if ($images) { ?>
                            <?php foreach ($images as $image) { ?>
                                <div class="item"><img src="<?php echo $image['thumbimage']; ?>" alt="<?php echo $heading_title; ?>" class="img-responsive" /></div>
                            <?php } ?>
                        <?php } ?>
                    </div>
