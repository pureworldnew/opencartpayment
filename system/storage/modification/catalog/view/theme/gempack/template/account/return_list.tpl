      ...
      <table class="table table-bordered table-hover">
        <thead>
          <tr>
            ...
            <td class="text-right hidden-xs"><?php echo $column_order_id; ?></td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-left hidden-xs"><?php echo $return['status']; ?></td>
            <td class="text-left"><?php echo $return['date_added']; ?></td>
            <td class="text-right hidden-xs"><?php echo $return['order_id']; ?></td>
            <td class="text-left hidden-xs"><?php echo $return['name']; ?></td>
