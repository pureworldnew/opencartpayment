...
<link rel="stylesheet" href="catalog/view/theme/default/stylesheet/bootstrap.min.css" crossorigin="anonymous">
			...
			<div class="profile hide" <?php if ($tmdaccount_bgimage) { ?> style="background:url('<?php echo $tmdaccount_bgimage; ?>');height:100%;" <?php } ?>>
				...
				<div class="detail col-sm-11">
					...
					<ul class="list-inline">
						<li>
							<span class="label"><?php echo $text_phone; ?></span>
							<?php echo $telephone; ?>
						</li>
						<li>
							<span class="label"><?php echo $text_email; ?></span>
							<?php echo $email; ?>
						</li>
						<li>
							<span class="label"><?php echo $text_address; ?></span>
							<?php echo $address_1; ?> , <?php echo $city; ?>
						</li>
					</ul>
					<div class="btnedit">
						...
						<tbody>
							...
							<?php foreach ($orders as $order) {  ?>
							 <tr>
                                ...
                                <td class="text-center"><a href="<?=$order['product_url']?>"><?php echo $order['name']; ?></a></td>
								<td class="text-center"><?php echo $order['noof_product']; ?></td>
								<td class="text-center"><?php echo $order['status']; ?></td>
								<td class="text-center"><?php echo number_format((float)$order['total'], 2, '.', ''); ?></td>
								<td class="text-center"><?php echo date("Y-m-d", strtotime($order['date_added'])); ?></td>
