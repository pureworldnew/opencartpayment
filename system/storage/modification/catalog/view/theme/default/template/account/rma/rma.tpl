          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-center"><?php echo $text_product; ?></td>
                <td class="text-center"><?php echo $text_reason; ?></td>
                <td class="text-left">
            ...
            <?php foreach ($rma_ress as $res) { ?>
              <tr>
                ...
                <td class="text-left"><?php echo $res['product']; ?></td>
                <td class="text-left"><?php echo $res['reason']; ?></td>
