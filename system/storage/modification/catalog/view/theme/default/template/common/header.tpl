...
<meta name="google-site-verification" content="MkGO8iqKgesxLW5IJEsDHb7Ky-YF-j98jTvBcnCOk8A" />
<?php if ($description) { ?>
...
<?php } ?>
<?php $revision=54; ?>
		<link href="catalog/view/theme/default/stylesheet/font.<?php echo $revision;?>.css" rel='stylesheet' type='text/css' lazyload>
		<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/bootstrap.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/stylesheet.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/style.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/jquery.selectbox.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/jquery.autocomplete.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/flexslider.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/jcarousel-tango-skin.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/bootstrap-responsive.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/css/jcarousel.responsive.<?php echo $revision;?>.css" />
        
        <link rel="stylesheet" type="text/css" href="catalog/view/javascript/jquery/ui/themes/ui-lightness/jquery-ui-1.8.16.custom.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/javascript/jquery/colorbox/colorbox.<?php echo $revision;?>.css" />
		<link rel="stylesheet" type="text/css" href="catalog/view/supermenu/newone.<?php echo $revision;?>.css" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/quick_login.<?php echo $revision;?>.css" />
		<?php foreach ($styles as $style) { ?>
        	<link href="<?php echo $style['href']; ?>?v=<?php echo $revision;?>" type="text/css" rel="<?php echo $style['rel']; ?>" media="<?php echo $style['media']; ?>" />
        <?php } ?>
		...
		<script type="text/javascript" src="catalog/view/javascript/jquery/jquery-1.7.1.min.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery/ui/jquery-ui-1.8.16.custom.min.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery/jquery.ui.touch-punch.min.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery/jquery.selectbox-0.2.min.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery/autocomplete.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery.accordion.source.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/bootstrap.min.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/common.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery.autocomplete.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery.myjcarousel.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery.jcarousel.min.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jcarousel.responsive.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery.flexslider-min.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery.placeholder.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery/jquery.validate.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery/colorbox/jquery.colorbox-min.<?php echo $revision;?>.js"></script>
        <script type="text/javascript" src="catalog/view/javascript/jquery/tabs.<?php echo $revision;?>.js"></script> 
        <script type="text/javascript" src="catalog/view/javascript/quick_login.<?php echo $revision;?>.js"></script>
        <?php if ( $current_route_page != 'quickcheckout/checkout' ) { ?> 
		    <script type="text/javascript" src="catalog/view/javascript/group.product.page.<?php echo $revision;?>.js"></script>
        <?php } ?>
<script type="text/javascript" src="catalog/view/javascript/fancySelect.<?php echo $revision;?>.js"></script>
...
<?php foreach ($links as $link) { ?>
    ...
    <?php }else{ ?>
	    <link href="<?php echo $link['href']; ?>?v=<?php echo $revision;?>" rel="<?php echo $link['rel']; ?>" />
    <?php }?>
<?php } ?>
<?php foreach ($scripts as $script) { ?>
 <script src="<?php echo $script; ?>?v=<?php echo $revision;?>" type="text/javascript"></script> 
<?php } ?>
<?php foreach ($analytics as $analytic) { ?>
<?php echo $analytic; ?>
<?php } ?>
<link rel="stylesheet" href="catalog/view/javascript/jquery.cluetip.<?php echo $revision;?>.css" type="text/css" />
			<script src="catalog/view/javascript/jquery.cluetip.<?php echo $revision;?>.js" type="text/javascript"></script>
  ...
  <div class="container">
	...
	<div id="top-links" class="nav pull-right">
      <ul class="list-inline">
								...
								<?php if(isset($quick_order_text)){ ?>
									<li><a href="<?php echo $quick_order; ?>" title="<?php echo $quick_order_text; ?>">
                    <i class="fa fa-share"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $quick_order_text; ?></span></a></li>
								<?php } ?>
