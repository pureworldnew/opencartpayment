...
class ControllerExtensionModule extends Controller {
	...
	public function uninstall() {
		...
		if ($this->validate()) {
			...
			if ($this->request->get['extension'] != 'pos') { $this->model_setting_setting->deleteSetting($this->request->get['extension']); }
...
$display_style = ($this->language->get('heading_title') == 'Product Labelsss') ? "style=display:none" : "";
				$data['extensions'][] = array(
