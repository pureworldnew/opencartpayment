...
<div id="content">
    ...
    <div class="container-fluid">
      <div class="pull-right">
        <a data-toggle="tooltip" title="Help guide for one page order entry system" class="btn btn-warning documentation" target="_blank" href="http://www.cartbinder.com/documentation/one-page-order-entry-system-with-custom-prices-for-products/#howtouse"><i class="fa fa-life-ring"></i> How to use</a>
        <a data-toggle="tooltip" title="Need help, create a ticket" class="btn btn-primary support" target="_blank" href="http://support.cartbinder.com/open.php"><i class="fa fa-life-ring"></i> Support / HelpDesk</a>
      </div>
    </div>
  </div>
  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <br>
      <small><i>Customized order entry systems</i></small>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=sale/orderq&token=<?php echo $token; ?>';
