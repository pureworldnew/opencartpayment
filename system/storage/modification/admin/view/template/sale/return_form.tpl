...
<?php if ($prm_access_permission && $laccess) { ?>	
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="cost" value="<?php echo $cost; ?>" placeholder="<?php echo $entry_cost; ?>" id="input-cost" class="form-control" style="background-color: #ffd7d7; border: thin solid #CCC;" />
                </div>
              </div>
<?php } else { ?>
