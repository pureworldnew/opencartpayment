              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if (!$extension['installed']) { ?>
                    ...
                    <?php
                if ( $extension['name'] == 'Products Label - FrontEnd' )
                {
                    $extension['edit'] = str_replace( "module/products_label", "localisation/products_label", $extension['edit'] );
                }
            ?>
            <a href="<?php echo $extension['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary" <?php echo $extension['display']; ?>><i class="fa fa-pencil"></i></a>
                    <?php } else { ?>
