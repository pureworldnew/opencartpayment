...
class Numbers_Words_Locale_en extends Numbers_Words
{
    ...
    var $_currency_names = array(
      ...
      'INR' => array(array('Indian Rupee'), array('paise', 'paise')),
      ...
      'LKR' => array(array('Sri Lankan rupee'), array('paise', 'paise')),
      'MKD' => array(array('Macedonian dinar'), array('deni')),
      'MTL' => array(array('Maltese lira'), array('centym')),
      'MUR' => array(array('Mauritian rupee'), array('paise', 'paise')),
      'MVQ' => array(array('Maldivian rupee'), array('paise', 'paise')),
      'NPR' => array(array('Nepalese rupee'), array('paise', 'paise')),
      'NOK' => array(array('Norwegian krone'), array('oere')),
      'PLN' => array(array('zloty', 'zlotys'), array('grosz')),
      'PKR' => array(array('Pakistani rupee'), array('paise', 'paise')),
      'ROL' => array(array('Romanian leu'), array('bani')),
      'RUB' => array(array('Russian Federation rouble'), array('kopiejka')),
      'SCR' => array(array('Seychelles rupee'), array('paise', 'paise')),
