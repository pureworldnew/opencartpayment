...
class ModelAccountAddress extends Model {
	...
	public function getComments() {
		$query = $this->db->query("SELECT comments FROM " . DB_PREFIX . "customer WHERE customer_id = '" . (int)$this->customer->getId() . "'");
		if(isset($query->row['comments'])){
