...
class ControllerCommonCartMobile extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/cartmobile.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/cartmobile.tpl', $data);
		} else {
			return $this->load->view('default/template/common/cartmobile.tpl', $data);
		}
	}
