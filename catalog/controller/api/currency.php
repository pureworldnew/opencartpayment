	...
	public function index() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($currency_info) {
				...
				if(isset($this->session->data['shipping_method'])) unset($this->session->data['shipping_method']);
				if(isset($this->session->data['shipping_methods'])) unset($this->session->data['shipping_methods']);
