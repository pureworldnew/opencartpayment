...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$mail->setSubject(html_entity_decode(sprintf($this->language->get('email_subject'), $this->request->post['name'], $this->request->post['enquiry_subject']), ENT_QUOTES, 'UTF-8')); 
			$mail->setText($this->request->post['enquiry']."\n"."Customer Email : ".$this->request->post['email']);
			$mail->send();
			if(isset($this->request->post['sendcopy'])){
