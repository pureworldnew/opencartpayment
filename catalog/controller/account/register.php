...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		$data['entry_resale_number'] = $this->language->get('entry_resale_number');
		...
		if (isset($this->request->post['resale_number'])) {
			$data['resale_number'] = $this->request->post['resale_number'];
		} else {
			$data['resale_number'] = '';
		}
...
$data['config_default']=$this->config->get('config_default');
$data['config_wholesale']=$this->config->get('config_wholesale');
	...
	private function validate() {
		...
		$custom_fields = array(); //$this->model_account_custom_field->getCustomFields($customer_group_id);
