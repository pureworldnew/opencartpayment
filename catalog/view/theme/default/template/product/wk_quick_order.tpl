  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            ...
            <?php  if(isset($products)){  ?>
                <?php foreach($products as $product) { ?>
                  <tr id="add_row-<?php echo $count; ?>" class="quick-row" data-cart-id="<?php echo $product['cart_id']; ?>">
                    ...
                    <td><input type="hidden"  id="product-name_<?php echo $count; ?>"  class="form-control product-name" style="height:45px;" value="<?php echo $product['name']; ?>"/>
                    ...
                    <td><input type="text" class="form-control sub-total" value="<?php echo $product['price']; ?>" style="height:45px;" readonly/></td>
                    <td class="text-center"><button type="button" name="button" class="btn btn-danger remove" style="height:45px;" onclick="cart.remove('<?php echo $product['cart_id']; ?>');"> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $count++; ?>
                <?php } ?>
            <?php } else { ?>
      ...
      <div class="text-left" style="margin-bottom:20px;">
        <button type="button" name="button" class="btn btn-primary" id="add-row" style="width:200px; height:45px;">
          <i class="fa fa-plus"></i>&nbsp;<?php echo $button_add_row; ?>
        </button>
        <!-- <button type="button" name="button" class="btn btn-danger" id="add-row" style="width:200px; height:45px; margin-left:730px;">
          Total = <sapn id="cart-total">500</span>
        </button> -->
      </div>
      <?php if(isset($products)){ ?>
        ...
        $.ajax({
          ...
          success: function(resp){
            ...
            html += ' <input type="hidden" id="product_id" name="product_id" value="'+item['value']+'" />'
    				html += '       <input type="button" value="<?php echo $button_cart; ?>" id="button-cart" data-loading-text="Please Wait" style="display:inline-block !important;" class="btn btn-primary" />';
