...
<table id="gp-table" class="gp-table">
  ...
  <?php if ($config_opt_key+1 & 1) { ?><tr class="gp-tbody gp-tbody-null" data-relazione-box="<?php echo $child_id; ?>"><?php } ?>
    <!-- Inizio cella n1 -->
    <?php if ($gp_column_image) { ?>
    ...
    <!-- Fine cella n2 //-->
  <?php if(!($config_opt_key+1 & 1)){ ?></tr><?php }elseif(count($config_options)==($config_opt_key+1)&&($config_opt_key+1 & 1)){ ?><td colspan="2"></td></tr><?php } ?>
  <?php } /*foreach product n*/ ?>
  <?php } elseif ($ot['option_type_switch'] == 's') { ?>
  <?php if ($config_opt_key+1 & 1) { ?><tr class="gp-tbody gp-tbody-select"><?php } ?>
    <!-- Inizio cella s1 -->
    <?php if ($gp_column_image) { ?>
    <td class="gp-tcell-1"><div style="<?php echo $img_col_w . $img_col_h; ?>">
      <?php foreach($ot['gp_products'] as $key => $child){ $child_id = $child['product_id']; ?>
	...
	//--></script>
  <?php if(!($config_opt_key+1 & 1)){ ?></tr><?php }elseif(count($config_options)==($config_opt_key+1)&&($config_opt_key+1 & 1)){ ?><td colspan="2"></td></tr><?php } ?><!-- Select //-->
    
  <?php } elseif ($ot['option_type_switch'] == 'r') { ?>
  <?php if ($config_opt_key+1 & 1) { ?><tr class="gp-tbody gp-tbody-radio"><?php } ?>
    <!-- Inizio cella r1 -->
    <?php if ($gp_column_image) { ?>
    <td class="gp-tcell-1"><div style="<?php echo $img_col_w . $img_col_h; ?>">
      <?php foreach($ot['gp_products'] as $key => $child){ $child_id = $child['product_id']; ?>
	...
	//--></script>
  <?php if(!($config_opt_key+1 & 1)){ ?></tr><?php }elseif(count($config_options)==($config_opt_key+1)&&($config_opt_key+1 & 1)){ ?><td colspan="2"></td></tr><?php } ?><!-- Radio //-->
  <?php } elseif ($ot['option_type_switch'] == 'c') { ?>
  <?php if ($config_opt_key+1 & 1) { ?><tr class="gp-tbody gp-tbody-checkbox"><?php } ?>
    <!-- Inizio cella c1 -->
    <?php if ($gp_column_image) { ?>
    <td class="gp-tcell-1"><div style="<?php echo $img_col_w . $img_col_h; ?>">
  ...
  <?php if ($config_opt_key+1 & 1) { ?><tr class="gp-tbody gp-tbody-inline"><?php } ?>
    <!-- Inizio cella i1 -->
    <?php if ($gp_column_image) { ?>
    <td class="gp-tcell-1"><div style="<?php echo $img_col_w . $img_col_h; ?>">
      <?php foreach ($ot['gp_products'] as $key => $child) { ?>
