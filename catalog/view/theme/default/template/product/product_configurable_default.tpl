...
<?php /* 
  #file: catalog/view/theme/default/template/product/product_configurable_default.tpl
...
<table id="gp-table" class="gp-table">
  ...
  <thead>
    <tr class="gp-thead">
      <?php if($gp_column_image){ ?><td><?php echo $gp_column_image; ?></td><?php } ?>
      <td><?php echo $gp_column_name; ?></td>
      <?php if(!$price_fixed){ ?><td><?php echo $gp_column_price; ?></td><?php } ?>
    </tr>
  </thead>
  <?php } ?>
  <tbody>
  ...
  <tr class="gp-tbody gp-tbody-null" data-relazione-box="<?php echo $child_id; ?>">
        ...
        <div class="child<?php echo $child_id; ?>">
          ...
          <?php if ($child['out_of_stock']) { ?>
            ...
            <div class="gp-box-qty">
              ...
              <select name="option[<?php echo $child_id; ?>]" disabled="disabled" title="<?php echo $button_cart_out; ?>"><option value="0">0</option></select>
              <?php } else { ?>
    ...
    <?php if (!$price_fixed) { ?>
    <td class="gp-tcell-3">
        <div class="gp-box-price child<?php echo $child_id; ?>">
          <?php if ($child['saving']) { ?>
          <div class="saving"><?php echo $child['saving']; ?></div><br />
          <?php } ?>
          <?php if ($child['rr_price']) { ?>
          <div class="rr-price"><?php echo $text_rrp; ?> <span><?php echo $child['rr_price']; ?></span></div>
          <?php } ?>
          <?php if (!$child['special']) { ?>
          <span class="price"><?php echo $child['price']; ?></span><br />
          <?php } else { ?>
          <span class="price-old"><?php echo $child['price']; ?></span> <span class="price-new"><?php echo $child['special']; ?></span><br />
          <?php } ?>
          <?php if ($child['tax']) { ?>
          <span class="price-tax"><?php echo $text_tax; ?> <?php echo $child['tax']; ?></span><br />
          <?php } ?>
        </div>
    </td>
    <?php  } ?>
  ...
  <tr class="gp-tbody gp-tbody-radio">
    ...
    <td class="gp-tcell-3">
        ...
        <div class="gp-box-price child<?php echo $child['product_id']; ?>">
		  <?php if ($child['saving']) { ?>
          <div class="saving"><?php echo $child['saving']; ?></div><br />
          <?php } ?>
          <?php if ($child['rr_price']) { ?>
    ...
    <td class="gp-tcell-2" colspan="2"><div style="position:relative;">
        ...
        <div class="gp-box-switch">
          ...
          <label id="c-l<?php echo $child_id; ?>" data-relazione-box="<?php echo $child_id; ?>">
            ...
            <?php if (!$price_fixed && $child['price']) { ?>
            <span class="gp-plus-price" title="<?php if($child['tax']){ echo $text_tax . ' ' . $child['tax']; } ?>"> +
              <?php if ($child['special']) { ?>
              <span class="price-old"><?php echo $child['price']; ?></span> <span class="price-new"><?php echo $child['special']; ?></span>
              <?php } else { ?>
              <span class="price"><?php echo $child['price']; ?></span>
              <?php } ?>
              <?php if($ot['option_qty_min']>1){ echo $text_each; } ?>
            </span>
            <?php } ?>
          </label>
          <!-- S info -->
		  ...
		  <script type="text/javascript"><!--
			...
			$("#c-l<?php echo $child_id; ?>, .gp-box-info.child<?php echo $child_id; ?>").mouseover(function(){
				$(".child<?php echo $child_id; ?>").show();$(".gp-box-info.child<?php echo $child_id; ?>").addClass("gp-box-info-focus");
			}).mouseout(function(){
				$(".child<?php echo $child_id; ?>").hide();$(".gp-box-info.child<?php echo $child_id; ?>").removeClass("gp-box-info-focus");
			});
			<?php } ?>
    ...
    <td class="gp-tcell-2" colspan="2"><div style="position:relative;">
        ...
        <div class="gp-box-switch">
		  ...
		  <script type="text/javascript"><!--
			<?php if (count($ot['gp_products']) > 1) { ?>
			$(".child<?php echo $child_id; ?>").hide();
			$("#i-l<?php echo $child_id; ?>, .gp-box-info.child<?php echo $child_id; ?>").mouseover(function(){
				$(".child<?php echo $child_id; ?>").show();$(".gp-box-info.child<?php echo $child_id; ?>").addClass("gp-box-info-hover");
			}).mouseout(function(){
				$(".child<?php echo $child_id; ?>").hide();$(".gp-box-info.child<?php echo $child_id; ?>").removeClass("gp-box-info-hover");
			});
			<?php } ?>
			$("[name=\"option[<?php echo $child_id; ?>]\"]").on("keyup change",function(){
				var qty=$(this).val();
...
//--></script>
<script type="text/javascript"><!--
//(function($){$.fn.myfunction=function(){alert('hello');};})(jQuery); //$("option",this).each(function(){
/*$("select.child-switch").on("change",function(){
	var hideChilds='';
	$("select.child-switch").each(function(){ alert($("option:selected",this).attr("data-relazione-hide"));
		if($("option:selected",this).attr("data-relazione-hide")){ hideChilds+=','+$("option:selected",this).attr("data-relazione-hide"); }
	});
	var nascondiAll=hideChilds.replace(',','');var nascondi=$.unique(nascondiAll.split(','));
	$.each(nascondi,function(arr,cid){ $('[data-relazione-box="'+cid+'"]').hide(); });
});*///Relazioni:
