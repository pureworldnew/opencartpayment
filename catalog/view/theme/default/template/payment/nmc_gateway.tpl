...
<div class="quickcheckout-content">
          ...
          <ul>
            <li class="dateYearLI">
              ...
              <select name="cc_expire_date_year">
                ...
                <option value="<?php echo substr($year['value'], 2, 2); ?>"><?php echo $year['text']; ?></option>
                <?php } ?>
              </select>
  ...
  <div class="g-recaptcha" data-sitekey="<?php echo $site_key; ?>" style="padding:12px;"></div> 
  <div style="clear:both; margin-bottom:90px;"></div>
  <div class="buttons" style="display: block;">
    <div class="" style="display: block;">
      <input type="button" class="button" id="button-confirm" value="Pay Now" style="background-color:#fe5930 !important;color:white !important;">
    </div>
  </div>
</div>
<!-- 
...
$('#button-confirm').on('click', function() {
	...
	<?php endif; ?>
	$.ajax({
		url: 'index.php?route=payment/nmc_gateway/send',
		type: 'post',
