...
<style>
    ...
    .product-info .left, .product-info .right {display: table-cell;vertical-align: top;}
...
<div id="content">
    ...
    <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $quick_name_general; ?></a>
    ...
    <div id="tab-general" class="tab-content">
        <div class="product-info" id='product-info'>
            <div class="left" style="<?php if ($quick_column_left_width) { ?>width: <?php echo $quick_column_left_width; ?><?php } ?>">
            ...
            <div class="right" style="<?php if ($quick_column_right_width) { ?>width: <?php echo $quick_column_right_width; ?><?php } ?> " >
    ...
    <?php if ($quick_tab_review && $review_status) { ?>
        <div id="tab-review" class="tab-content">
            <div id="review"></div>
            <h2 id="reviewtitle"><?php echo $text_write; ?></h2>
...
<script>
    ...
    $('#button-review').bind('click', function() {
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('#reviewtitle').after('<div class="attention"><img src="catalog/view/theme/default/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
            },
            complete: function() {
            ...
            success: function(data) {
                if (data['error']) {
                    $('#reviewtitle').after('<div class="warning">' + data['error'] + '</div>');
                }

                if (data['success']) {
                    $('#reviewtitle').after('<div class="success">' + data['success'] + '</div>');
    ...
    $(document).ready(function() {
		...
		var default_conversion_value_name = $("#qv_get-unit-data").find('option:selected').attr('name');
