...
<div class="<?php echo $direction; ?>">
  ...
  <table class="product">
	...
	<tr>
    <td style="width: 3%;"><?php echo $product['order_item_sort_order']; ?></td>	 
		<?php foreach ($columns as $col) { ?>
			<td <?php if(in_array($col, array('weight', 'quantity', 'qty_check', 'price', 'tax'))){ ?>class="right"<?php } ?> <?php if(in_array($col, array('image', 'weight', 'quantity', 'qty_check', 'tax'))){ ?>style="width:1px"<?php } ?>>
                    ...
                    <?php 
                     ...
                     }else if($col == 'qty_shipped' || $col == 'qty_check'){
				...
				<?php } elseif($col == 'price') { 
                        ...
                        { 
                          ...
                          $markup = ($product['unique_price_discount'] > 0 ) ? 1/(float)$product['unique_price_discount'] : 0;
                          echo "Markup: " . number_format((float)($markup), 4, '.', '') . "</div>";
                        }  
                        ?>
				<?php }else{ ?>
  ...
  <table class="comment">
    ...
    <tr>
      <td>Additional Cost added to Total: <b><?php echo $additional_cost; ?></b></td>
      <td>Payment Authorization Amount: <b><?php echo $authorization_amount; ?></b></td>
    </tr>
  </table>
  <?php } ?>
