...
<div class="row">
    ...
    <?php
        if ($column_left and $column_right) $class="col-lg-8 col-md-6 col-sm-4 col-xs-12";
        else if ($column_left or $column_right) $class="col-lg-10 col-md-9 col-sm-8 col-xs-12";
        else $class="col-xs-12";
    ?>
                                ...
                                <?php if ($videos) { $i = 0; ?>
                                    <?php foreach ($videos as $video) { ?>
                                        <?php if ($video['file_type'] == 'youtube'){ ?>
                                            <li class="media_additional" style="display: inline-block;width: 50%;padding: 3px;"><iframe class="media_thumbnail" src="<?php echo $video['video']; ?>"></iframe></li>
                                        <?php } else {?>
                                            <?php if ($poster) { ?>
                                                <li class="media_additional" style="display: inline-block;width: 50%;padding: 3px;"><a class="media_thumbnail" href="<?php echo $video['video'];?>" id="video"><video class="media_thumbnail" controls preload="none" poster = '<?php echo $poster;?>'><source src="<?php echo $video['video'];?>" type="<?php echo $video['video_type']; ?>">Your browser does not support the video tag.</video></a></li>
                                            <?php } else { ?>
                                                <li class="media_additional" style="display: inline-block;width: 50%;padding: 3px;"><a class="media_thumbnail" href="<?php echo $video['video'];?>" id="video"><video class="media_thumbnail" onloadedmetadata="loadVideoThumb()"><source src="<?php echo $video['video'];?>" type="<?php echo $video['video_type']; ?>">Your browser does not support the video tag.</video></a></li>
                                            <?php } ?>
                                        <?php } ?>
                                    <?php $i++; } ?>
                                <?php } ?>
                                    ...
                                    <div class="panel panel-default panel-default-options">
                                        ...
                                        <div id="option-<?php echo str_replace(' ', '-', strtolower($text_groupby)); ?>" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <select name="select_product" class='form-control grouped_product_select'>
                                                ...
                                                if (strtolower(end($UnitArry)) != "units") { ?>
                                                    <div class="panel panel-default panel-default-options">
                                                        ...
                                                        <b style="display: none;"><?php echo $option['name']; ?>:</b>
                                                            <div class="panel-body">
                                                                <select name="option[<?php echo $option['product_option_id']; ?>]" class="form-control" onChange="checkit(this);">
                            ...
                            <div class="panel-group product-panel-group" style="max-width: 400px;">
                                <?php if ($options) { ?>
                                    <div class="panel panel-default" style="margin-top: 5px;">
                                        <div class="panel-heading">
                                            <h4 class="panel-title text-center"><small>There are <span id="item-number" style="font-size:16px;"><?php echo $total_options_product; ?></span> items with these options.</small></h4>
                                        </div>
                            ...
                            <?php if ($flag) { ?>
                                ...
                                <div class="item text-center">
                                    <div class="product-item">
                                        ...
                                        <div class="price"><span>SEE ALL</span><span class="unit-products"></span></div>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
                    ...
                    <div class="box-content" id="related_prods">
                        <div id="related_prods_load" class="owl-carousel product-carousel">
                            ...
                            <?php foreach ($products as $rproduct) : ?>
                                ...
                                <div class="item text-center">
                                    <div class="product-item">
                                        <div class="name"><a href="<?php echo $rproduct['href']; ?>" title="<?php echo $rproduct['name']; ?>"><?php echo $rproduct['name']?></a></div>
                                        <?php if ($rproduct['thumb']) { ?>
                                            <div class="image"><a href="<?php echo $rproduct['href'] ?>"><img src="<?php echo $rproduct['thumb'] ?>" title="<?php echo $rproduct['name']; ?>" alt="<?php echo $rproduct['name']; ?>"></a></div>
                                        <?php } else { ?>
                                            <div class="image"><img src="<?php echo HTTP_SERVER; ?>catalog/view/theme/default/image/no_product.jpg" title="<?php echo $heading_title; ?>" alt="<?php echo $rproduct['name']; ?>" /></div>
                                ...
                                <?php if ($discounts) { ?>
                                    ...
                                    <ul class="update_discount_price_group">
                                        ...
                                        <?php foreach ($discounts as $key => $discount) {
                                            ...
                                            <li>
                                                <span class="scale-quantity"><?php echo $discount['quantity'] . $nextQuan . " " . $unit_plural; ?></span>
...
<script>
    function updateTextInput(val) {
        var rangename = val;
        $(rangename).attr("title",rangename.value);
        $(rangename).attr("data-original-title",rangename.value);
        var tooltip = $(rangename).attr("aria-describedby")
        $("#"+tooltip+" .tooltip-inner").html(rangename.value);
