...
class ModelCatalogAttribute extends Model {
	public function addAttribute($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "attribute SET attribute_group_id = '" . (int)$data['attribute_group_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', show_on_front = '" . (int)$data['show_on_front'] . "'");
	...
	public function editAttribute($attribute_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "attribute SET attribute_group_id = '" . (int)$data['attribute_group_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', show_on_front = '" . (int)$data['show_on_front'] . "' WHERE attribute_id = '" . (int)$attribute_id . "'");
