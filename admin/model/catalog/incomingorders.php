<?php
class ModelCatalogIncomingorders extends Model {
	public function addProduct($data) {
		$this->event->trigger('pre.admin.product.add', $data);

		$this->db->query("INSERT INTO " . DB_PREFIX . "product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', ean = '" . $this->db->escape($data['ean']) . "', jan = '" . $this->db->escape($data['jan']) . "', isbn = '" . $this->db->escape($data['isbn']) . "', mpn = '" . $this->db->escape($data['mpn']) . "', location = '" . $this->db->escape($data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "',  minimum_amount = '" . (float)$data['minimum_amount'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW(), estimate_deliver_time = '" . (int)$data['estimate_deliver_time'] . "', date_sold_out = '" . $data['date_sold_out'] . "', date_ordered = '" . $data['date_ordered'] . "'");
	...
	public function editProduct($product_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', ean = '" . $this->db->escape($data['ean']) . "', jan = '" . $this->db->escape($data['jan']) . "', isbn = '" . $this->db->escape($data['isbn']) . "', mpn = '" . $this->db->escape($data['mpn']) . "', location = '" . $this->db->escape($data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', minimum_amount = '" . (float)$data['minimum_amount'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_modified = NOW(), estimate_deliver_time = '" . (int)$data['estimate_deliver_time'] . "', date_sold_out = '" . $data['date_sold_out'] . "', date_ordered = '" . $data['date_ordered'] . "' WHERE product_id = '" . (int)$product_id . "'");
...
if(!empty($data['filter_grouped'])){ $sql .= " AND p.model != 'grouped'"; }
		...
		if (isset($data['filter_quantity']) && !is_null($data['filter_quantity'])) {
			switch($data['filter_quantity_operator'])
			{
				case 'greater' : $operator = '>'; break;
				case 'less' : $operator = '<'; break;
				default : $operator = '=';
			}
			$sql .= " AND p.quantity {$operator} '" . $this->db->escape($data['filter_quantity']) . "'";
		} else {
			$sql .= " AND p.quantity < '1' AND p.incoming_request='0' ";
		}
	...
	public function getTotalProducts($data = array()) {
		...
		if (isset($data['filter_quantity']) && !is_null($data['filter_quantity'])) {
			...
			$sql .= " AND p.quantity {$operator} '" . (int)$data['filter_quantity'] . "'";
		} else {
