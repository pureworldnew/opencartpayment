<?php
/*
  #file: admin/model/catalog/product_bundle.php
...
class ModelCatalogProductBundle extends Model {
	...
	public function populateProductGroupedDatabaseFields($product_id, $data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "product_grouped_type SET product_id = '" . (int)$product_id . "', pg_type = 'bundle', pg_layout = '" . $data['pg_layout'] . "'");
