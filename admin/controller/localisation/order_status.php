...
class ControllerLocalisationOrderStatus extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_color'] = 'Order Row Color #';
		...
		if (isset($this->request->post['order_status_color'])) {
			$data['order_status_color'] = $this->request->post['order_status_color'];
		} elseif (isset($this->request->get['order_status_id'])) {
			$data['order_status_color'] = $this->model_localisation_order_status->getOrderStatuscolor($this->request->get['order_status_id']);
		} else {
