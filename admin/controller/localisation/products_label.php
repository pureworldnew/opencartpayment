<?php
class ControllerLocalisationProductslabel extends Controller {
    private $error = array();
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->model_localisation_products_label->editlabel($this->request->post);
            ...
            $this->response->redirect($this->url->link('localisation/products_label', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    protected function validateForm() {
        if (!$this->user->hasPermission('modify', 'localisation/products_label')) {
