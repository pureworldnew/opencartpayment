...
class ControllerAbandonedCartsSetting extends Controller {
	...
	protected function validate() {
		...
		if ($this->request->post['abandoned_carts_crownjob_status']) {
			if (empty($this->request->post['abandoned_carts_abandoned_template_id'])) {
				$this->error['warning'] = $this->language->get('error_abandoned_template');
			}
		}
