...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['user_groups'] = $this->model_setting_setting->getusergroups();
		...
		if (isset($this->request->post['config_users_group'])) {
			$data['config_users_group'] = $this->request->post['config_users_group'];
		} else {
			$data['config_users_group'] = $this->config->get('config_users_group');
		}
		...
		if (isset($this->request->post['estimatedays'])) {
			...
			$product_id = 0;
			$data['estimatedays'] = $this->model_catalog_product->getProductEstimateDays($product_id);
		}
		...
		if (isset($this->request->post['config_additional_percentage'])) {
			$data['config_additional_percentage'] = $this->request->post['config_additional_percentage'];
		} else {
			$data['config_additional_percentage'] = $this->config->get('config_additional_percentage');
		}
		...
		$data['captcha_pages'][] = array(
			'text'  => $this->language->get('text_password_forgot'),
