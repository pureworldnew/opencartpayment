...
class ControllerCatalogAttribute extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_show_on_front'] = $this->language->get('entry_show_on_front');
		...
		if (isset($this->request->post['show_on_front'])) {
			$data['show_on_front'] = $this->request->post['show_on_front'];
		} elseif (!empty($attribute_info)) {
			$data['show_on_front'] = $attribute_info['show_on_front'];
		} else {
			$data['show_on_front'] = '1';
		}
