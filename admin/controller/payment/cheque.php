...
class ControllerPaymentCheque extends Controller {
	...
	public function index() {
		...
		$data['entry_admin_text_color'] = "Admin Text Color";
		$data['entry_admin_background_color'] = "Admin Background Color";
		...
		if (isset($this->request->post['cheque_admin_text_color'])) {
			$data['cheque_admin_text_color'] = $this->request->post['cheque_admin_text_color'];
		} else if(!empty($this->config->get('cheque_admin_text_color'))) {
			$data['cheque_admin_text_color'] = $this->config->get('cheque_admin_text_color');
		} else {
			$data['cheque_admin_text_color'] = '#000000';
		}

		if (isset($this->request->post['cheque_admin_background_color'])) {
			$data['cheque_admin_background_color'] = $this->request->post['cheque_admin_background_color'];
		} else if(!empty($this->config->get('cheque_admin_background_color'))) {
			$data['cheque_admin_background_color'] = $this->config->get('cheque_admin_background_color');
		} else {
			$data['cheque_admin_background_color'] = '#ffffff';
		}
