...
class ControllerUserUserPermission extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_pos_access'] = 'POS Tabs Permission';
		...
		if (isset($this->request->post['permission']['product_info'])) {
			$data['product_info'] = $this->request->post['permission']['product_info'];
		} elseif (isset($user_group_info['permission']['product_info'])) {
			$data['product_info'] = $user_group_info['permission']['product_info'];
		} else {
			$data['product_info'] = array();
		}

		if (isset($this->request->post['permission']['update_stock'])) {
			$data['update_stock'] = $this->request->post['permission']['update_stock'];
		} elseif (isset($user_group_info['permission']['update_stock'])) {
			$data['update_stock'] = $user_group_info['permission']['update_stock'];
		} else {
			$data['update_stock'] = array();
		}

		if (isset($this->request->post['permission']['incoming_orders'])) {
			$data['incoming_orders'] = $this->request->post['permission']['incoming_orders'];
		} elseif (isset($user_group_info['permission']['incoming_orders'])) {
			$data['incoming_orders'] = $user_group_info['permission']['incoming_orders'];
		} else {
			$data['incoming_orders'] = array();
		}

		if (isset($this->request->post['permission']['backorders'])) {
			$data['backorders'] = $this->request->post['permission']['backorders'];
		} elseif (isset($user_group_info['permission']['backorders'])) {
			$data['backorders'] = $user_group_info['permission']['backorders'];
		} else {
			$data['backorders'] = array();
		}

		if (isset($this->request->post['permission']['returns'])) {
			$data['returns'] = $this->request->post['permission']['returns'];
		} elseif (isset($user_group_info['permission']['returns'])) {
			$data['returns'] = $user_group_info['permission']['returns'];
		} else {
			$data['returns'] = array();
		}

		if (isset($this->request->post['permission']['sales_report'])) {
			$data['sales_report'] = $this->request->post['permission']['sales_report'];
		} elseif (isset($user_group_info['permission']['sales_report'])) {
			$data['sales_report'] = $user_group_info['permission']['sales_report'];
		} else {
