...
ini_set('session.cookie_lifetime', 12000000);
ini_set('session.cache_expire', 12000000);
...
if ( !isset($request->get['token']) && isset($session->data['token']) )
{
...
//background Tasks
$registry->set('bgprocess', new bgp($registry));
