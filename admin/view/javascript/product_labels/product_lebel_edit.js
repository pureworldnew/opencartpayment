...
function preview_template() {
    $.ajax({
        url: "index.php?route=module/product_labels/previewtemplate&token=" + token + get_uri(),
        success: function(a) {
...
function delete_template() {
    return id = $("input[name='templateid']").val(), id == settings.product_labels_default_templ ? (alert(error_delete_template), !1) : void $.ajax({
        url: "index.php?route=module/product_labels/deletetemplate&token=" + token + "&id=" + id,
        beforeSend: function() {
...
function save_template() {
    $.ajax({
        url: "index.php?route=module/product_labels/savetemplate&token=" + token + get_uri() + "&id=" + $("input[name='templateid']").val(),
        beforeSend: function() {},
        complete: function() {
            $(".loading").remove()
        },
...
function preview_label() {
    if (validate_form()) {
        $.ajax({
            url: "index.php?route=module/product_labels/savelabel&token=" + token + "&action=savelabel&id=1",
            type: "post",
...
function preview_label_order(order_token) {
    if (validate_form()) {
        $.ajax({
            url: "index.php?route=module/product_labels/savelabel&token=" + order_token + "&action=savelabel&id=1",
            type: "post",
            data: get_label_serialized()
        });
        var a = "index.php?route=" + $("input[name='route']").val() + "&token=" + order_token + "&sample=1&edit=1&templateid=" + $("select[name='templateid']").val() + "&orientation=" + $("select[name='orientation']").val() + "&labelid=1",
            b = new PDFObject({
                url: a,
                id: "PDFPreview",
                pdfOpenParams: {
...
function delete_label() {
    return id = $("select[name='select_label']").val(), id == settings.product_labels_default_label ? (alert(error_delete_label), !1) : void $.ajax({
        url: "index.php?route=module/product_labels/deletelabel&token=" + token + "&id=" + id,
        beforeSend: function() {
...
function save_label() {
    $.ajax({
        url: "index.php?route=module/product_labels/savelabel&token=" + token + "&saveas_label_name=" + $("input[name='saveas_label_name']").val() + "&id=" + $("select[name='select_label'] option:selected").val(),
        type: "post",
        data: get_label_serialized(),
        beforeSend: function() {},
        complete: function() {
...
function select_label() {
    $.ajax({
        url: "index.php?route=module/product_labels/getlabel&token=" + token + "&id=" + $("select[name='select_label'] option:selected").val(),
        type: "post",
        dataType: "json",
        success: function(a) {
            ...
            $("#form_elements").html(b), $(function() {
                $(".labeltext").autocomplete(autocomp_label_elements), $(".color").colorPicker(colorpicker_color), $(".fill").colorPicker(colorpicker_fill)
...
function select_label_order(order_token) {
    $.ajax({
        url: "index.php?route=module/product_labels/getlabel&token=" + order_token + "&id=" + $("select[name='select_label'] option:selected").val(),
        type: "post",
        dataType: "json",
        success: function(a) {
            a.data || (a.data = "{}"), elements = jQuery.parseJSON(a.data);
            ...
            $("#form_elements").html(b), $(function() {
                ...
                "" != $("select[name='select_label']").val() ? $("#savebutton_label").attr("style", "visibility:visible") : $("#savebutton_label").attr("style", "visibility:hidden")
            }), "" != $("select[name='select_label']").val() ? ($("#deletebutton_label").attr("style", "visibility:visible"), $("#exportbutton_label").attr("style", "visibility:inline;margin-top:10px")) : ($("#deletebutton_label").attr("style", "visibility:hidden"), $("#exportbutton_label").attr("style", "visibility:hidden;margin-top:10px")), $("#savebutton_label").attr("style", "visibility:hidden"), preview_label_order(order_token)
        }
    })
}
...
function check_update() {
    $.ajax({
        url: "index.php?route=module/product_labels/checkupdate&token=" + token,
        success: function(a) {
...
function get_update_info() {
    $.ajax({
        url: "index.php?route=module/product_labels/getupdateinfo&token=" + token,
        success: function(a) {
            a && $("#notes").html(a)
        }
    })
...
function get_template(a) {
    $.ajax({
        url: "index.php?route=module/product_labels/gettemplate&token=" + token + "&id=" + a,
        dataType: "json",
        success: function(a) {
            if (a) {
...
function get_label(a) {
    $.ajax({
        url: "index.php?route=module/product_labels/get_label&token=" + token + "&id=" + a,
        dataType: "json",
        success: function(a) {
...
function update_preview() {
    ...
    var a = "index.php?route=module/product_labels/labels&token=" + token + "&orderids=1&sample=1&templateid=" + template_id + "&labelid=" + label_id + "&orientation=" + orientation,
        b = new PDFObject({
            url: a,
            id: "PDFPreview",
            pdfOpenParams: {
...
function generate_label_options() {
    $.ajax({
        url: "index.php?route=module/product_labels/getlabeloptions&token=" + token + "&product_id=" + product_id,
        dataType: "json",
...
$(window).load(function() {
    $("#add_options").click(function() {
        ...
        var a = "index.php?route=module/product_labels/checkinstall&token=" + token;
        ...
        $.ajax({
            url: "index.php?route=module/product_labels/gettemplate&token=" + token + "&id=" + $("select[name='template'] option:selected").val(),
            type: "post",
            dataType: "json",
            success: function(a) {
