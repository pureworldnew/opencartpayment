...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        $.getScript("view/javascript/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
         ...
         //   fileInput.change(function () {
				...
				var container_id = $(this).parent().parent().parent().parent().parent().parent().parent().parent().attr('id');
				$('#currentpanel').val(container_id)
                obj.errorLog.html("");
                var fileExtensions = s.allowedTypes.toLowerCase().split(",");
                var fileArray = [];
