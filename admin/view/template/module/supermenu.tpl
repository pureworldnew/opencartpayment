					...
					<div class="row">
						<div class="col-sm-5 col-xs-12" >
							...
							<div class="settings-row">
								Menu Status
								<?php if ($supermenu_showstatus) { ?>
                					<input type="radio" name="supermenu_showstatus" value="1" checked="checked" />
                					<?php echo $text_no; ?>
                					<input type="radio" name="supermenu_showstatus" value="0" />
                					<?php echo $text_yes; ?>
                				<?php } else { ?>
                					<input type="radio" name="supermenu_showstatus" value="1" />
                					<?php echo $text_no; ?>
                					<input type="radio" name="supermenu_showstatus" value="0" checked="checked" />
                					<?php echo $text_yes; ?>
        						<?php } ?>		  
							</div>
							<div class="settings-row">
