        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-3">
              ...
              <div class="form-group">
                <label class="control-label" for="input-company-id">Company ID</label>
                <div class="">
                  <input type="text" name="filter_company_id" value="<?php echo $filter_company_id; ?>" placeholder="Company ID"  id="input-company-id" class="form-control" />
                  </div>
              </div>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['company_id']; ?></td>
...
$('#button-filter').on('click', function() {
  ...
  var filter_company_id = $('input[name=\'filter_company_id\']').val();
