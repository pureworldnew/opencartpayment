...
function loadreports(){
	$('#misc-block').load('index.php?route=<?php echo $base_route; ?>/hb_sitemap/customlinks&token=<?php echo $token; ?>&store_id=<?php echo $store_id; ?>');
}
...
$('#store').on('change', function() {
	window.location.href = 'index.php?route=<?php echo $base_route; ?>/hb_sitemap&token=<?php echo $token; ?>&store_id='+$('#store').val();
});

$('#add-htacess-code').on('click', function() {
	$('#msgoutput').html('');
	$.ajax({
		  url: 'index.php?route=<?php echo $base_route; ?>/hb_sitemap/addhtaccess&token=<?php echo $token; ?>&store_id=<?php echo $store_id; ?>',
		  dataType: 'json',		
		  beforeSend: function() {
...
function addlink(){
	...
	$.ajax({
		  type: 'post',
		  url: 'index.php?route=<?php echo $base_route; ?>/hb_sitemap/addlink&token=<?php echo $token; ?>&store_id=<?php echo $store_id; ?>',
...
function deletelink(){
	...
	$.ajax({
		  type: 'post',
		  url: 'index.php?route=<?php echo $base_route; ?>/hb_sitemap/deletelink&token=<?php echo $token; ?>&store_id=<?php echo $store_id; ?>',
...
function fixDates(){
	$.ajax({
		  url: 'index.php?route=<?php echo $base_route; ?>/hb_sitemap/fixdates&token=<?php echo $token; ?>',
		  dataType: 'json',	
		  success: function(json) {
				if (json['success']) {
					  $('#msgoutput').html('<div class="pr_success"><i class="fa fa-check"></i> '+json['success']+'</div>');
...
function importBulk(){
	$.ajax({
		  type: 'post',
		  url: 'index.php?route=<?php echo $base_route; ?>/hb_sitemap/importbulk&token=<?php echo $token; ?>&store_id=<?php echo $store_id; ?>',
		  dataType: 'json',	
