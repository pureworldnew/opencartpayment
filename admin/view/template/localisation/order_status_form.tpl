          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                <input type="text" name="order_status_color" value="<?php echo (isset($order_status_color) ? $order_status_color : ''); ?>" placeholder="<?php echo $entry_color; ?>" class="form-control" />
              </div>
              </div>
            </div>
        </form>
