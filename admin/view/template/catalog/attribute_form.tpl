    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-attribute" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-show-on-front"><?php echo $entry_show_on_front; ?></label>
            <div class="col-sm-10">
              <select name="show_on_front" id="input-show-on-front" class="form-control">
                <option value="1">Yes</option>
                <?php if($show_on_front == 0){ ?>
