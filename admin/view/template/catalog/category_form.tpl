        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sort-by"><?php echo $entry_sort_by; ?></label>
                <div class="col-sm-10">
                  <select name="sort_by" id="input-sort-by" class="form-control">
                    <option value="">Select Sort By</option>
                    <option value="name" <?php if($sort_by == 'name') { echo "selected"; } ?>>Product Name</option>
                    <option value="product_id" <?php if($sort_by == 'product_id') { echo "selected"; } ?>>Product ID</option>
                    <option value="date_added" <?php if($sort_by == 'date_added') { echo "selected"; } ?>>Data Added</option>
                    <option value="date_modified" <?php if($sort_by == 'date_modified') { echo "selected"; } ?>>Data Modified</option>
                    <option value="model" <?php if($sort_by == 'model') { echo "selected"; } ?>>Model Number</option>
                    <option value="price" <?php if($sort_by == 'price') { echo "selected"; } ?>>Price</option>
                    <option value="sold" <?php if($sort_by == 'sold') { echo "selected"; } ?>>Sold</option>
                  </select>
                </div>
                <div class="col-sm-10 col-sm-offset-2">
                <label class="radio-inline">
                  <input type="radio" name="sorting_order" value="ASC" <?php if($sorting_order != 'DESC') { echo 'checked'; } ?>> <span style="position: relative;top: -3px;left: 4px;">Ascending</span>
                </label>
                <label class="radio-inline">
                  <input type="radio" name="sorting_order" value="DESC" <?php if($sorting_order == 'DESC') { echo 'checked'; } ?>> <span style="position: relative;top: -3px;left: 4px;">Descending</span>
                </label>
                </div>
              </div>
              <div class="form-group">
...
$('#input-description<?php echo $language['language_id']; ?>').summernote({
  fontSizes: ['8', '9', '10', '11', '12', '14','16', '18', '24', '30', '36','42','48', '54', '60','72'],
	height: 300 
});
<?php } ?>
//--></script> 
