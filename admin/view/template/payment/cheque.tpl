    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cheque" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-admin-text-color"><?php echo $entry_admin_text_color; ?></label>
            <div class="col-sm-10">
              <input type="color" name="cheque_admin_text_color" value="<?php echo $cheque_admin_text_color; ?>" placeholder="<?php echo $entry_admin_text_color; ?>" id="input-admin-text-color" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-admin-background-color"><?php echo $entry_admin_background_color; ?></label>
            <div class="col-sm-10">
              <input type="color" name="cheque_admin_background_color" value="<?php echo $cheque_admin_background_color; ?>" placeholder="<?php echo $entry_admin_background_color; ?>" id="input-admin-background-color" class="form-control" />
            </div>
          </div>
        </form>
      </div>
