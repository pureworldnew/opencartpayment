...
<div class="well">
    <div class="row" style="margin-bottom:10px;">
      <div class=<?php echo (($filter_report == 'all_products_with_without_orders' or $filter_report == 'products_abandoned_orders') ? "col-lg-6" : (($filter_report == 'products_without_orders' or $filter_report == 'products_shopping_carts' or $filter_report == 'products_wishlists') ? "col-lg-12" : "col-lg-4")) ?> style="background:#f2f2f2; border:1px solid #DDD; margin-top:1px;">
		...
		<?php } elseif ($filter_report == 'products_abandoned_orders') { ?>
    ...
    <div id="filters" class="row filters-switcher <?php echo (isset($_COOKIE['show-ppp-filters']) && $_COOKIE['show-ppp-filters'] == 1) ? '' : 'row hide-filters'; ?>">   
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('affiliate_name', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="padding-bottom:15px;">
      ...
      <?php } ?>
      <?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists') { ?> 
      <?php if (in_array('affiliate_email', $advppp_settings_filters)) { ?>      
    	<div class="col-lg-2" style="padding-bottom:15px;">
  ...
  <div class="modal-dialog modal-lg modal-info">
    <div class="modal-content" id="modal-content">
      ...
      <fieldset>
		...
		<div class="row" style="padding:2px;">
			<div class="col-sm-12"><div class="input-group" style="width:100%;">
				<span class="input-group-addon" style="width:51%; white-space:normal; text-align:left;"><?php echo $text_formula_setting6; ?></span>
				<select name="advppp<?php echo $user; ?>_formula_6" data-style="btn-select" data-width="15%" class="select">
                ...
                <span class="input-group-addon" style="width:19%; white-space:normal; text-align:left;"><?php echo $text_return_action; ?></span>
...
<?php if ($filter_report == 'all_products_with_without_orders' or $filter_report == 'products_without_orders' or $filter_report == 'products_shopping_carts' or $filter_report == 'products_wishlists') { ?>
		<div id="checkbox_filter_scw_pnp_alp" class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:130px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php } ?>                
				<div class="well well-sm" style="background:#f5f5f5; height:250px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php if ($filter_report == 'products_shopping_carts' or $filter_report == 'products_wishlists') { ?>   
		...
		<div id="checkbox_scw_column" class="row">
			<div class="col-sm-12">
				<div class="well well-sm" style="background:#f5f5f5; height:245px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php if ($filter_report == 'products_purchased_without_options' or $filter_report == 'products_purchased_with_options' or $filter_report == 'new_products_purchased' or $filter_report == 'old_products_purchased' or $filter_report == 'products_options' or $filter_report == 'manufacturers' or $filter_report == 'categories' or $filter_report == 'suppliers' or $filter_report == 'products_abandoned_orders') { ?>    
		<div id="checkbox_all_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:545px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
			...
			<?php foreach ($advppp_cron_settings as $advppp_cron_setting) { ?>
			  <tbody id="adv_cron_settings_row<?php echo $adv_cron_settings_row; ?>">
				<tr>                
                  ...
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_affiliate_name]" value="<?php echo $advppp_cron_setting['cron_filter_affiliate_name']; ?>" />
                  <input type="hidden" name="advppp_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_affiliate_email]" value="<?php echo $advppp_cron_setting['cron_filter_affiliate_email']; ?>" />
...
<?php } ?>
<div id="charts" class="chart-switcher <?php echo (isset($_COOKIE['show-ppp-chart']) && $_COOKIE['show-ppp-chart'] == 1) ? '' : 'hide-chart'; ?>">  
	<?php if ($filter_report != 'all_products_with_without_orders' && $filter_report != 'products_without_orders' && $filter_report != 'products_abandoned_orders' && $filter_report != 'products_shopping_carts' && $filter_report != 'products_wishlists' && $filter_details != 'all_details_products' && $filter_details != 'all_details_orders' && $filter_group == 'no_group' && $filter_limit != '999999') { ?>       
...
<?php if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') { ?>
	...
	<?php if ($products && $filter_limit != '999999') { ?>          
		...
		<tr bgcolor="#FFFFFF">
          ...
          <?php } ?>
          <?php if (in_array('all_prod_option', $advppp_settings_all_columns)) { ?>    
          <td class="left" nowrap="nowrap" title="<?php echo $column_prod_option; ?> [<?php echo $column_order_order_id; ?>: <?php echo $product['order_id']; ?>]">
          <?php if ($product['product_option']) { ?>  
          <?php $resultstr = array(); ?>         
          <?php foreach ($product['product_option'] as $product_option) { ?>            
		  <?php $resultstr[] = $product_option['name'].': '.$product_option['value']; ?>
          <?php } ?>
          <?php $result_options = implode("; ",$resultstr); ?>
...
<?php if ($filter_details != 'all_details_products' && $filter_details != 'all_details_orders' && $filter_limit != '999999') { ?>
    <table class="list_main">
        <thead>
          ...
          <?php foreach ($product['option'] as $option) { ?> 
		  <small><?php echo $option['quantity']; ?></small><br />
		  <?php } ?><?php } ?>
		  <?php } ?>
          </td>          
          <?php } ?>
...
<script type="text/javascript">
function filter() {
	url = 'index.php?route=report/adv_products_profit&token=<?php echo $token; ?>';										 
...
$('input[name=\'filter_customer_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_customer_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('input[name=\'filter_customer_email\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_customer_email=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_customer_telephone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_customer_telephone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_ip\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_ip=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_company\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_payment_company=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_address\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_payment_address=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_city\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_payment_city=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_zone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_payment_zone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_postcode\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_payment_postcode=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_payment_country=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_company\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_shipping_company=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_address\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_shipping_address=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_city\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_shipping_city=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_zone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_shipping_zone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_postcode\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_shipping_postcode=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/customer_autocomplete&token=<?php echo $token; ?>&filter_shipping_country=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_sku\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/product_autocomplete&token=<?php echo $token; ?>&filter_sku=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_product_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/product_autocomplete&token=<?php echo $token; ?>&filter_product_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/product_autocomplete&token=<?php echo $token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_coupon_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/coupon_autocomplete&token=<?php echo $token; ?>&filter_coupon_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_voucher_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=report/adv_products_profit/voucher_autocomplete&token=<?php echo $token; ?>&filter_voucher_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	  ...
	  function drawChart() { 
		...
		<?php if ($filter_report == 'products_purchased_without_options' || $filter_report == 'products_purchased_with_options' || $filter_report == 'new_products_purchased' || $filter_report == 'old_products_purchased' || $filter_report == 'products_abandoned_orders') {
			...
			echo "['" . $column_name . "','". $column_sold_quantity . "'],";
					...
					foreach ($products as $key => $product) {
						if (count($products)==($key+1)) {
							echo "['" . $product['gsupplier'] . "',". $product['gsold'] . "]";
						} else {
							echo "['" . $product['gsupplier'] . "',". $product['gsold'] . "],";
						}
						if (++$i > 9) break;
        ...
        var options = {
			title: <?php if ($filter_report != 'products_abandoned_orders' && $filter_report != 'manufacturers' && $filter_report != 'categories' && $filter_report != 'suppliers') {
			...
			chart.draw(data, options);
  			...
  			$(".chart-button").mousemove(function() {
        		chart.draw(data, options);
    		});	
...
<script type="text/javascript"><!--
	  ...
	  function drawChart() { 
   		var data = google.visualization.arrayToDataTable([
		<?php if ($filter_report == 'products_purchased_without_options' || $filter_report == 'products_purchased_with_options' || $filter_report == 'new_products_purchased' || $filter_report == 'old_products_purchased' || $filter_report == 'products_abandoned_orders') {
			echo "['" . $column_name . "','". $column_gsales . "','" . $column_gcosts . "','" . $column_gprofit . "'],";
					$i = 0;
					foreach ($products as $key => $product) {
						if (count($products)==($key+1)) {
							echo "['" . $product['gname'] . "',". $product['gsales'] . ",". $product['gcosts'] . ",". $product['gprofit'] . "]";
						} else {
							echo "['" . $product['gname'] . "',". $product['gsales'] . ",". $product['gcosts'] . ",". $product['gprofit'] . "],";
						}
						if (++$i > 9) break;
			...
			echo "['" . $column_name . "','". $column_gsales . "','" . $column_gcosts . "','" . $column_gprofit . "'],";
					...
					foreach ($products as $key => $product) {
						if (count($products)==($key+1)) {
							echo "['" . $product['gmanufacturer'] . "',". $product['gsales'] . ",". $product['gcosts'] . ",". $product['gprofit'] . "]";
						} else {
							echo "['" . $product['gmanufacturer'] . "',". $product['gsales'] . ",". $product['gcosts'] . ",". $product['gprofit'] . "],";
						}
						if (++$i > 9) break;
			...
			echo "['" . $column_name . "','". $column_gsales . "','" . $column_gcosts . "','" . $column_gprofit . "'],";
					...
					foreach ($products as $key => $product) {
						if (count($products)==($key+1)) {
							echo "['" . $product['gcategories'] . "',". $product['gsales'] . ",". $product['gcosts'] . ",". $product['gprofit'] . "]";
						} else {
							echo "['" . $product['gcategories'] . "',". $product['gsales'] . ",". $product['gcosts'] . ",". $product['gprofit'] . "],";
						}
						if (++$i > 9) break;
			...
			echo "['" . $column_name . "','". $column_gsales . "','" . $column_gcosts . "','" . $column_gprofit . "'],";
					...
					foreach ($products as $key => $product) {
						if (count($products)==($key+1)) {
							echo "['" . $product['gsupplier'] . "',". $product['gsales'] . ",". $product['gcosts'] . ",". $product['gprofit'] . "]";
						} else {
							echo "['" . $product['gsupplier'] . "',". $product['gsales'] . ",". $product['gcosts'] . ",". $product['gprofit'] . "],";
						}
						if (++$i > 9) break;
...
$('#save_settings').on('click', function(){
	$.ajax ({
		url: 'index.php?route=report/adv_products_profit/settings&token=<?php echo $token; ?>',		
		type: 'post',
...
$('#save_report').on('click', function(){
	$.ajax ({
		url: 'index.php?route=report/adv_products_profit/load_save_report&token=<?php echo $token; ?>',		
		type: 'post',
...
function addCron() {
	...
	html += '<input type="hidden" id="cron_filter_affiliate_name" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_affiliate_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_affiliate_email" name="advppp_cron_setting[' + adv_cron_settings_row + '][cron_filter_affiliate_email]" value="" />';
...
$('#export_report').on('click', function(){
	var url_exp ='index.php?route=report/adv_products_profit/export&token=<?php echo $token; ?>';
	...
	$.ajax ({
		url: 'index.php?route=report/adv_products_profit/export_validate&token=<?php echo $token; ?>',
		type: 'post',
...
$('#save_cron').on('click', function(){
	...
	$.ajax ({
		url: 'index.php?route=report/adv_products_profit/cron&token=<?php echo $token; ?>',		
		type: 'post',
...
function cron_command() {
	...
	var addr = link+"&cron_route="+"report/adv_products_profit"+"&user_id="+user+"&cron_token="+token+"&cron_id="+id+"&cron=1";
