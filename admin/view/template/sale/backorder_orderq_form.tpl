            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php $backorder_order_id = !empty($order_id) ? $order_id : ""; ?>
                  <input type="hidden" name="order_id" value="<?php echo $backorder_order_id; ?>" />
                </td>
              </tr> 
...
$('#cart').delegate('.btn-danger','click',function(){
   ...
   $.ajax({
    type:"GET",
    url:'index.php?route=sale/backorder/editbackorder_row&token=<?php echo $token; ?>&product_id='+this.value+'&order_id=<?php echo $_GET["order_id"]; ?>',
    cache:false,
    success:function(data){
...
$('#button-save').on('click', function() {
    ...
    var url = $('select[name=\'store\'] option:selected').val() + 'index.php?route=api/oqorder/addbackorder&token=' + token;
  } else {
