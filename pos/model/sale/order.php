...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'resale_text'             => $order_query->row['resale_text']
	...
	public function getSalesPersons() {
		$query = $this->db->query("SELECT user_id, username, CONCAT(firstname, ' ', lastname) as name FROM " . DB_PREFIX . "user WHERE user_group_id = 13");
