...
<div id="oc_content" class="container-fluid" style="padding: 0;">
	<div id="divWrap" class="wrapper">
		<div class="header">
			<!-- <div class="logo" style="width:210px !important">
			...
			<div class="left-container">
				...
				<div class="left-nav">
					...
					<ul>
						...
						<li><a onclick="changeOrderStatus();"><span class="bg"><span class="icon order-status"></span></span><span class="txt" id="order_status_name"><?php echo !empty($order_status_name) ? $order_status_name : 'Change Order Status'; ?></span></a></li>
						<?php if (empty($config['hide_pos_shipping'])) { ?>
						<li><a onclick="changeShippingDetails();"><span class="bg"><span class="icon shipping"></span></span><span class="txt" id="shipping_method"><?php echo ($shipping_method=="Instore Shipping")?"Select Shipping":$shipping_method; ?></span></a></li>
						<?php }?>
						<li><a onclick="changeOrderCustomer();"><span class="bg"><span class="icon customer"></span></span><span class="txt" id="order_customer_name"><?php echo ($customer=="In Store Guest")?"Select Customer":$customer; ?></span></a></li>
						<li><a onclick="orderHistory();"><span class="bg"><span class="icon book"></span></span><span class="txt" id="order_history_customer">Order History</span></a></li>
                ...
                <div class="left-nav shortcuts">
                	<h2>Settings</h2>
                    <ul>
                    <li><a href="<?php echo $pos_settings; ?>"><span class="bg"><span class="icon cog"></span></span><span class="txt">POS Settings</span></a></li>
                    <li><a href="<?php echo $back_to_admin_dashboard; ?>"><span class="bg"><span class="icon cog"></span></span><span class="txt">Go To Admin</span></a></li>
                  </ul>
                </div>
				<div class="left-nav shortcuts">
					...
					<ul>
						...
						<li><a ><span class="bg"><span class="icon book"></span></span><span class="txt" id="stock_manager">Stock Manager</span></a>
							<br/>
							<a href="javascript:void(0);" onclick="accessStockManger('#tab_product_information');"><span style="color: #c5c5c5;" class="txt" id="">  --Update Product Information</span></a>
							<a href="javascript:void(0);" onclick="accessStockManger('#tab_update_stock');"><span style="color: #c5c5c5;"  class="txt" id="">  --Update Stock</span></a>
							<a href="javascript:void(0);" onclick="accessStockManger('#tab_incoming_orders');"><span style="color: #c5c5c5;"  class="txt" id="">  --Incoming orders</span></a>
                            <a href="javascript:void(0);" onclick="showReturn();"><span style="color: #c5c5c5;"  class="txt" id="">  --Returns</span></a>
							<a href="javascript:void(0);" onclick="accessStockManger('#tab_sales_report');"><span style="color: #c5c5c5;"  class="txt" id="">  --Sales Report</span></a>
						</li>
			...
			<div class="tabbable-panel">
				<div class="tabbable-line">
					<ul class="nav nav-tabs">
						<li>
							<a href="#tab_product_information" data-toggle="tab" id="tab_product_information_tab" onclick="cancelEditProduct();">
							Edit Product Information </a>
						</li>
						<li>
							<a href="#tab_update_stock" data-toggle="tab" onclick="cancelEditProduct();" id="update_stock_tab_id">
							Update Stock </a>
						</li>
						<li>
							<a href="#tab_incoming_orders" data-toggle="tab" onclick="loadIncomingOrders();">
							Incoming Orders </a>
						</li>
						<li>
							<a href="#tab_backorders" data-toggle="tab" onclick="loadBackOrders();">
							BackOrders </a>
						</li>
                        <li class="active">
							<a href="#tab_returns" data-toggle="tab" id="tab_returns_tab">
							Returns </a>
						</li>
						<li>
							<a href="#tab_sales_report" data-toggle="tab">
							Sales Report </a>
						</li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane" id="tab_product_information">
							
						</div>
						<div class="tab-pane" id="tab_update_stock">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <input id="button-refresh" type="button" class="btn btn-primary" value="Refresh" onClick="refreshData()"/> 
		<button id="newReturn" class="pull-right btn btn-success">Create New Return</button>
		<br><br>
          <div class="table-responsive">
            <table id="returnLists" class="table table-striped table-bordered" style="width:100%">
              <thead>
                <tr>
                  <td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
                  <td class="text-right"><?php if ($sort == 'r.type') { ?>
                    <a class="<?php echo strtolower($order); ?>">Return Type</a>
                    <?php } else { ?>
                    <a>Return Type</a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($return['return_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php echo (($return['type'])==0?"Gempacked":"POS"); ?></td>
                  ...
                  <td class="text-right"><a href="<?php echo $return['edit']; ?>" id="oit" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
<div id="editProductPage" class="modal fade bd-example-modal-xl" role="dialog">
  <div style="width: 70%;" class="modal-dialog modal-xl">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			...
			<div class="right-container"> 
				...
				<div class="prdct-container" id="main-container">
					<div class="prdct-header">
						...
						<div class="prdct-header-top" id="add_product_control">
							<div class="input-box">
								<input onclick="locationChange();" type="search" autocomplete="off" id="search" class="search_products" name="filter_product"  placeholder="<?php echo $text_search_placeholder; ?>" >
				...
				<div class="prdct-container" id="updateStockContainer" style="display:none">
					<div class="row">
						<div class="col-sm-2">
								...
								<input type="hidden" name="order_product[<?php echo $product_row; ?>][product_normal_price]" value="<?php echo $product['normal_price']; ?>" />
									...
									<td align="left" valign="middle" class="two">
										<span class="product-name">
											<span class="raw-name" onclick="showProductDetails(<?php echo $product['product_id'] ?>)" id="order_product[<?php echo $product_row; ?>][order_product_display_name]"><?php echo $product['name']; ?></span>
										...
										<?php if ( $product['price'] < $product['normal_price']) { 
											 if($product['converstion_line'] !='') {
												$percent = (1 - $product['discounted_price_for_percent'] / $product['normal_price']) * 100;
											 } else {
												$percent = (1 - $product['price'] / $product['normal_price']) * 100;
											 }
											?>
											<span class="highlight" onclick="changePrice(this);"><strike><a id="price_anchor_<?php echo $product_row; ?>">@ <?php echo $product['normal_price_text']; ?></a></strike></span>
											&nbsp;&nbsp;
											<span id="discounted_price_for_percent_<?php echo $product_row; ?>"> <?php echo $product['converstion_line'] !='' ? $product['text_discounted_price_for_percent'] : $product['price_text']; ?> (<?php echo round($percent); ?>% off!)</span>
										<?php } else { ?>
									...
									<td align="center" valign="middle" class="three">
										<small>SKU :  <?php echo $product['model']; ?></small><br/>
										(<small><?php echo round($product['labour_cost'],4); ?> </small> + 
										<small><?php echo round($product['unique_option_price'],6); ?> </small> ) <br /> 
										...
										<?php } else {?>
											<?php if ( $product['price'] < $product['normal_price']) { ?>
												<a onclick="$('#price_anchor_<?php echo $product_row; ?>').closest('span').trigger('click');" class="cart-link">
												<span class="product-price" id="total_text_only-<?php echo $product_row; ?>"><strike><?php echo $product['normal_price_total_text']; ?></strike></span></a>
												<span id="normal_total_text_only-<?php echo $product_row; ?>">Your price: <?php echo $product['total_text']; ?></span>
											<?php } else { ?>
												<a onclick="$('#price_anchor_<?php echo $product_row; ?>').closest('span').trigger('click');" class="cart-link">
									...
									<td align="center" valign="middle" class="four">
										<!-- <a class="delete" onclick="deleteOrderProduct(this)"></a> -->
					...
					<div class="cart-footer">
						<div class="pay-area-bg">
							<div class="cart-totals">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" id="normal">
                                	<?php if( !empty( $current_order_subtotal ) ) : ?>
                                      <tr class="SubtotalTr">
                                          <td align="right" valign="middle"><?php echo 'Sub Total' ?> :</td>
                                          <td align="left" valign="middle" ><span id="subtotal_total" class="highlight"><?php echo "$" . number_format((float)$current_order_subtotal, 2, '.', ''); ?></span></td>                     
                                          
                                          <td align="right" valign="middle">Discount :</td>
										  <td align="left" valign="middle"><span class="amount" id="order_discount_amount"><?php echo $order_discount_amount; ?></span></td>
                                      </tr>
                                    
                                    <?php else : ?>
                                      <tr class="SubtotalTr" style="display:none;">
                                          <td align="right" valign="middle"><?php echo 'Sub Total' ?> :</td>
                                          <td align="left" valign="middle" ><span id="subtotal_total" class="highlight"></span></td>                    
                                    ...
                                    <?php if( isset( $current_order_shipping ) ) : ?>
                                      <tr class="shippingTr">
                                            <td align="right" valign="middle"><?php echo 'Shipping' ?> :</td>
                                            <td align="left" valign="middle"><span id="shipping_total" class="highlight"><?php echo "$" . number_format((float)$current_order_shipping, 2, '.', ''); ?></span></td>                    
                                    ...
                                    <?php else : ?>
                                      <tr class="shippingTr" style="display:none;">
                                          <td align="right" valign="middle"><?php echo 'Shipping' ?> :</td>
                                          <td align="left" valign="middle"><span id="shipping_total" class="highlight">$0.00</span></td>   
                                    ...
                                    <?php if( !empty( $current_order_tax ) ) : ?>
                                    
                                        <tr class="taxTr">
                                            <td align="right" valign="middle"><?php echo 'Sales Tax' ?> :</td>
                                            <td align="left" valign="middle"><span id="tax_total" class="highlight"><?php echo "$" . number_format((float)$current_order_tax, 2, '.', ''); ?></span></td>                    

                                            <td rowspan="3" colspan="2" align="left"><a class="pay-btn" onclick="makePayment();"><span><?php echo $text_pay; ?></span></a></td>
                                        </tr>
                                    
                                    <?php else : ?> 
                                        <tr class="taxTr">
                                            <td align="right" valign="middle"><span><?php echo 'Sales Tax' ?> :</span></td>
                                            <td align="left" valign="middle"><span id="tax_total" class="highlight">$0.00</span></td>    
							...
							<!-- For tablet portrait mode -->
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" id="portrait" style="display:none">
                                	<?php if( !empty( $current_order_subtotal ) ) : ?>
                                      <tr class="SubtotalTr">
                                          <td align="right" valign="middle"><?php echo 'Sub Total' ?> :</td>
                                          <td align="left" valign="middle" ><span id="subtotal_total_res" class="highlight"><?php echo "$" . number_format((float)$current_order_subtotal, 2, '.', ''); ?></span></td>                     
                                          
                                          <td align="right" valign="middle">Discount :</td>
										  <td align="left" valign="middle"><span class="amount" id="order_discount_amount"><?php echo $order_discount_amount; ?></span></td>

										  <td rowspan="5"  align="left"><a class="pay-btn" onclick="makePayment();"><span><?php echo $text_pay; ?></span></a></td>
                                    ...
                                    <?php else : ?>
                                      <tr class="SubtotalTr" >
                                          <td align="right" valign="middle"><?php echo 'Sub Total' ?> :</td>
                                          <td align="left" valign="middle" ><span id="subtotal_total" class="highlight">$0.00</span></td>                    
                                    ...
                                    <?php if( isset( $current_order_shipping ) ) : ?>
                                      <tr class="shippingTr">
                                            <td align="right" valign="middle"><?php echo 'Shipping' ?> :</td>
                                            <td align="left" valign="middle"><span id="shipping_total_res" class="highlight"><?php echo "$" . number_format((float)$current_order_shipping, 2, '.', ''); ?></span></td>                    
                                    ...
                                    <tr class="grand-total">
										<td align="right" valign="middle" rowspan="2"><?php echo $text_grandtotal; ?> :</td>
										<?php $total_text = ''; if (!empty($totals)) { foreach ($totals as $total) { if ($total['code'] == 'total') { $total_text = $total['text']; break; } } } ?>
										<td align="left" valign="middle" id="payment_total" rowspan="2"><span class="highlight" onclick="showTotals();"><?php echo $total_text; ?></span></td>                    

										<td align="right" valign="middle"><?php echo 'Sales Tax' ?> :</td>
                                        <td align="left" valign="middle"><span id="tax_total_res" class="highlight"><?php echo "$" . number_format((float)$current_order_tax, 2, '.', ''); ?></span></td>
									</tr>
									
                                    <tr>
										<td align="right" valign="middle"><?php echo $text_amount_due; ?> :</td>
										<td align="left" valign="middle"><span class="amount" id="payment_due_amount_res"><?php echo $payment_due_amount_text; ?></span></td>
									</tr>
    ...
    text-align: center;
    float: left;
    text-align: center;" class="buttons-wrap">
							...
							<a class="btn discount btn-before-after-payment" onclick="setDiscount();"><span class="icon"></span><?php echo $text_give_discount; ?></a>
                            <?php if($order_has_tax) : ?>
                                  <a class="btn btn-primary" id="resale_id_number" onclick="openResaleDialog();"><span>Enter Resale ID Number</span></a>
                            <?php else : ?>
                                  <a class="btn btn-primary btn-before-after-payment" id="resale_id_number" onclick="openResaleDialog();" style="display:none;"><span>Enter Resale ID Number</span></a>
                            <?php endif; ?>
            ...
            <table id="nreturnLists" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $return['date_added']; ?></td>
                  <!--<td class="text-left"><?php // echo $return['date_modified']; ?></td>-->
                  <td class="text-right"><a href="<?php echo $return['edit']; ?>" id="oit" data-toggle="tooltip" title="" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
  ...
  <script>
      ...
      $('#nreturnLists').DataTable();
		...
		<div style="height:430px;" id="customer_dialog" class="fbox_cont change_add_details">
			...
			<div id="return_list_pagination" class="table-pagination"></div>
                  	 ...
                  	 <div class="tab-pane active" id="tab_customer_select">
                  	 	...
                  	 	<ul class="form_list">
									...
									<tr>
								<td align="right"><li>
									<label class="btn btn-success"><i class="fa fa-user"></i> Customer </label></td>
									<td><div class="inputbox" style="display:inline-block"><input name="customer_firstname_tab" type="text" value="">
                                    <ul id="append_customer"></ul>
									</div>
								</li></td>
								<td colspan="2">
									<a onclick="resetCustomer();" class="table-btn-common customer reset"><span class="icon"></span><?php echo "Reset Customer"; ?></a>                
							...
							<tr>
								<td align="right"><li>
									<label class=""><?php echo $entry_firstname; ?></label></td>
									<td><div class="inputbox" style="display:inline-block"><input name="customer_firstname_tab1" type="text" value="">
							...
							<td align="right">
								<li>
									<label><?php echo $entry_telephone; ?> <em>*</em></label></td><td>
									<div class="inputbox"><input name="customer_telephone_tab" type="text" value=""></div>
								</li> 
							</td>
							</tr>
							<tr>
								<td align="right"><li>
									<label><?php echo $entry_lastname; ?> <em>*</em></label></td><td>
									<div class="inputbox"><input name="customer_lastname_tab" type="text" value=""></div>
								</li></td>
								<td align="right"><li>
									<label><?php echo $entry_fax; ?></label></td><td>
									<div class="inputbox"><input name="customer_fax_tab" type="text" value=""></div>
								</li></td>
							</tr>
							<tr>
								<td align="right"><li>
									<label><?php echo $entry_email; ?> <em>*</em></label></td><td>
									<div class="inputbox"><input name="customer_email_tab" type="text" value=""></div>
								</li></td>
								<td align="right"><li>
									<label><?php echo $entry_resale_number; ?></label></td><td>
									<div class="inputbox"><input name="customer_resale_number_tab" type="text" value=""></div>
								</li></td>
							</tr>
							<tr>
                                ...
                                <td align="right"><li>
									<label><?php echo $entry_notes; ?></label></td><td>
									<div class="inputbox"><input name="customer_notes_tab" type="text" value=""></div>
								</li></td>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_customer_general">
                            <ul class="form_list">
                                ...
                                <li>
									<label><?php echo $entry_resale_number; ?></label>
									<div class="inputbox"><input name="customer_resale_number" type="text" value="<?php echo empty($customer_resale_number) ? '' : $customer_resale_number; ?>"></div>
								</li>
                                
                                <li>
									<label><?php echo $entry_notes; ?></label>
									<div class="inputbox"><input name="customer_notes" type="text" value="<?php echo empty($customer_notes) ? '' : $customer_notes; ?>"></div>
								</li>
								<span id="customer_extra_info" <?php if (empty($customer_id)) {?> style="display: none;"<?php }?>>
									<!--<li>
										<label><?php echo $entry_password; ?></label>
                  ...
                  <!--- Raza Umer ---->
					...
					<div class="form-group">
					  <label class="control-label col-sm-2">Customer Notes
					  </label>
					  <div class="col-sm-10">
		        	...
		        	<div class="table-container">
		            	<a class="skip_content filter_tab"><?php echo $button_filter; ?> <span class="icon"></span></a>
		       			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_orderlist table_customerlist">
							...
							<tbody id="orderhistor_list_customers_tab">
							</tbody>
						</table>
		        	</div><!--table-container-->
				</div>
		...
		<div id="order_payments_dialog" class="fbox_cont payment">
            ...
            <div class="fbox_btn_wrap">
				...
				<span id="post_payment_action_div">
                	...
                	<a id="button_receipt_complete" class="table-btn-common button_receipt_complete_dev" onclick="choose_order_status();">Apply Payment</a>
		...
		<div id="search_settings_dialog" class="fbox_cont search_scope">
			...
			<div class="table-container form-box">
         		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_search_scope">
					<?php $trClass = 'even'; ?>
					<?php $search_scopes = array('name'=>$text_search_product_name, 'model'=>$text_search_model_name, 'manufacturer'=>$text_search_manufacturer, 'sku'=>'SKU', 'upc'=>'UPC', 'mpn'=>'MPN', 'isbn'=>'ISBN'); ?>
			...
			<div class="table-container form-box">
         		<ul class="form_list">                
                	<li>
										...
										<a id="button_order_action_<?php echo $post_order_status_id; ?>" data-id="<?php echo $post_order_status_id; ?>" class="table-btn-common" onclick="clickPaymentbtn(<?php echo $post_order_status_id; ?>);" style="width:30%; margin-bottom:15px;margin-left:12px;float:left;"><?php echo $post_order_status_name; ?></a>
										<?php } } ?>  
                 </li>                   
            </ul>                 
			</div>
	...
	function fillPaidAmount(amount){
     ...
     $("#paidamount").html(parseFloat(prev_amount)+parseFloat(amount));
            ...
            function locationChange()
            {
				...
				//if (getOS() === "MacOS" && getUserAgent() !== "Safari"){
                	//window.location = 'ios:onCodeBoxClicked';
                //}
            }
