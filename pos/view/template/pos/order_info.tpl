...
$('#button-history').on('click', function() {
	...
	$.ajax({
		url: 'index.php?route=api/order/history&token=' + token + '&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
...
$('#button-sales-person').on('click', function() {
	...
	$.ajax({
		url: 'index.php?route=sale/order/assignsp&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&sales_person=' + encodeURIComponent($('select[name=\'sales_person\']').val()),
