...
<table border="0" align="center" width="100%">
	...
	<tr>
		...
		<td align="right" valign="top"><strike><?php echo $product['text_before_discount']; ?></strike></td>
	...
	<?php }?>
	<tr><td>&nbsp;</td><td align="left"><?php echo $product['model']; ?></td></tr>
	<!--<tr><td>&nbsp;</td><td align="left"><?php if ($barcode_for_product) { ?><div id="barcode_13_total_<?php echo $row_num; ?>"><?php echo $product['ean']; ?></div><?php } else { echo $product['ean']; }?></td></tr>-->
	<?php $row_num++; } ?>
	</tbody>
	...
	<tr>
		...
		<table width="100%">
			...
			<tr>
				<td align="left" valign="top" style="border-bottom: 1px dashed #000000;" colspan="2">Resale ID #</td>
				<td align="right" valign="top" style="border-bottom: 1px dashed #000000;"><?php echo $order['resale_text']; ?></td>
			</tr>
			<?php } ?>
			</tbody>
		</table>
    ...
    <?php if( !empty( $order['comment'] ) ) : ?>
    	<tr><td colspan="4" align="center" id="order_comment">Order Notes : <?php echo $order['comment']; ?></td></tr>
    <?php endif; ?>
