...
$(document).delegate('#button-invoice', 'click', function() {
	$.ajax({
		url: 'index.php?route=backorder/order/createinvoiceno&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		dataType: 'json',
		beforeSend: function() {
...
function getAdditionalCostAjax(order_id){
  ...
  $.ajax({
   type:"GET",
   url :"index.php?route=backorder/order/getAjaxAdditionalCost&token=<?php echo $token; ?>&order_id="+order_id,
   cache:false,
   dataType:"json",
   success:function(json){
...
$(document).delegate('#button-reward-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=backorder/order/addreward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=backorder/order/removereward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=backorder/order/addcommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=backorder/order/removecommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$('#button-history').on('click', function() {
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				$('#history').load('index.php?route=sale/backorder/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');
...
$('#button-sales-person').on('click', function() {
	...
	$.ajax({
		url: 'index.php?route=backorder/order/assignsp&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&sales_person=' + encodeURIComponent($('select[name=\'sales_person\']').val()) + '&username=' + encodeURIComponent($('input[name=\'username\']').val()),
		...
		dataType: 'json',			
			success: function(json) {
				...
				$('#history').load('index.php?route=backorder/order/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');
			}
