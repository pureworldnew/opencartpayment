        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-return" class="form-horizontal">
          ...
          <div class="tab-pane active" id="tab-general">
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-orignal-price"><?php echo $entry_orignal_price; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="orignal_price" value="<?php echo $orignal_price; ?>" placeholder="<?php echo $entry_orignal_price; ?>" id="input-orignal-price" class="form-control"  readonly="readonly"/>
                </div>
              </div>
              <div class="form-group">
