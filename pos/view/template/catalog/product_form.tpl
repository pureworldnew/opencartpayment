  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading pull-right">
        <?php if(isset($permissions['product_info'][0]) && !empty($permissions['product_info'][0]) && $permissions['product_info'][0] == 'edit_access'){ ?>
        <button id="form-product-btn" title="<?php echo $button_save; ?>" class="btn btn-primary" onclick="saveUpdatedProduct();"><i class="fa fa-save"></i></button>
        <?php } ?>  
        <button title="<?php echo $button_cancel; ?>" class="btn btn-default" onclick="cancelEditProduct();"><i class="fa fa-reply"></i></button>
      </div>
