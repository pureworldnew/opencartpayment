...
class ControllerCatalogProduct extends Controller {
	...
	public function history() {
		...
		if(isset($data['permissions']['sales_report'][0]) && !empty($data['permissions']['sales_report'][0]) && $data['permissions']['sales_report'][0] == 'no_access'){
			echo "<br />";	
...
///karapuz (ka_csv_product_import.ocmod.xml) 
		...
		$this->response->setOutput($this->load->view('catalog/sale_history.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if(isset($data['permissions']['product_info'][0]) && !empty($data['permissions']['product_info'][0]) && $data['permissions']['product_info'][0] == 'no_access'){
			echo "<br />";	
			echo '<p style="color:red;font-weight:600">You Don\'t Have Permission To View This Page!</p>';
			return;
		}
