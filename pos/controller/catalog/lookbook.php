...
$this->load->model('catalog/lookbook');
$output_dir = "../../../image/lookbook/tagthumbs/";
...
$output_dir = "../../../image/lookbook/";
	...
	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($lookbook_total) ? (($page - 1) * $this->config->get('config_admin_limit')) + 1 : 0, ((($page - 1) * $this->config->get('config_admin_limit')) > ($lookbook_total - $this->config->get('config_admin_limit'))) ? $lookbook_total : ((($page - 1) * $this->config->get('config_admin_limit')) + $this->config->get('config_admin_limit')), $lookbook_total, ceil($lookbook_total / $this->config->get('config_admin_limit')));
        ...
        $this->template = 'catalog/lookbook_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
